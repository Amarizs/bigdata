...
class WinNTFileSystem extends java.io.FileSystem {
    ...
    @Override
    public String resolve(java.io.File f) {
    ...
    @Override
    public String canonicalize(String path) throws java.io.IOException {
                ...
                if (useCanonPrefixCache) {
                    ...
                    if (dir != null) {
                        ...
                        if (resDir != null) {
                            ...
                            cache.put(dir + java.io.File.separatorChar + filename, res);
                        }
                    }
                }
                if (res == null) {
            ...
            String filename) throws java.io.IOException
    {
        return canonicalizeWithPrefix0(canonicalPrefix,
                canonicalPrefix + java.io.File.separatorChar + filename);
    }
    ...
    @Override
    public native boolean checkAccess(java.io.File f, int access);
    ...
    @Override
    public native boolean setPermission(java.io.File f, int access, boolean enable,
                                        boolean owneronly);
    ...
    @Override
    public native String[] list(java.io.File f);
    ...
    private native boolean delete0(java.io.File f);
    ...
    private native boolean rename0(java.io.File f1, java.io.File f2);
    ...
    public java.io.File[] listRoots() {
        ...
        for (int i = 0; i < 26; i++) {
            if (((ds >> i) & 1) != 0)
                fs[j++] = new java.io.File((char)('A' + i) + ":" + slash);
        }
        return fs;
    }
    ...
    @Override
    public long getSpace(java.io.File f, int t) {
        if (f.exists()) {
    ...
    private native long getSpace0(java.io.File f, int t);
