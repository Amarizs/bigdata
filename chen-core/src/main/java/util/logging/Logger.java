...
public class Logger {
    ...
    Logger(String name, String resourceBundleName, Class<?> caller, LogManager manager, boolean isSystemLogger) {
        ...
        this.name = name;
        levelValue = java.util.logging.Level.INFO.intValue();
    }
     ...
     * @since   1.8
     */
    public void logp(java.util.logging.Level level, String sourceClass, String sourceMethod,
     ...
     *                         can be null
     * @param   msg     The string message (or a key in the message catalog)
     * @deprecated Use {@link #logrb(java.util.logging.Level, String,
     * String, ResourceBundle, String,
     * Object...)} instead.
     */
    @Deprecated
    public void logrb(java.util.logging.Level level, String sourceClass, String sourceMethod,
    ...
    public void entering(String sourceClass, String sourceMethod) {
        logp(java.util.logging.Level.FINER, sourceClass, sourceMethod, "ENTRY");
    }
    ...
    public void entering(String sourceClass, String sourceMethod, Object param1) {
        logp(java.util.logging.Level.FINER, sourceClass, sourceMethod, "ENTRY {0}", param1);
    }
    ...
    public void entering(String sourceClass, String sourceMethod, Object params[]) {
        String msg = "ENTRY";
        if (params == null ) {
           logp(java.util.logging.Level.FINER, sourceClass, sourceMethod, msg);
           return;
        }
        if (!isLoggable(java.util.logging.Level.FINER)) return;
        for (int i = 0; i < params.length; i++) {
            msg = msg + " {" + i + "}";
        }
        logp(java.util.logging.Level.FINER, sourceClass, sourceMethod, msg, params);
    }
    ...
    public void exiting(String sourceClass, String sourceMethod) {
        logp(java.util.logging.Level.FINER, sourceClass, sourceMethod, "RETURN");
    }
    ...
    public void exiting(String sourceClass, String sourceMethod, Object result) {
        logp(java.util.logging.Level.FINER, sourceClass, sourceMethod, "RETURN {0}", result);
    }
    ...
    public void throwing(String sourceClass, String sourceMethod, Throwable thrown) {
        if (!isLoggable(java.util.logging.Level.FINER)) {
            return;
        }
        LogRecord lr = new LogRecord(java.util.logging.Level.FINER, "THROW");
        lr.setSourceClassName(sourceClass);
        lr.setSourceMethodName(sourceMethod);
        lr.setThrown(thrown);
        doLog(lr);
    ...
    public void config(String msg) {
        log(java.util.logging.Level.CONFIG, msg);
    }
    ...
    public void finest(String msg) {
        log(java.util.logging.Level.FINEST, msg);
    }
    ...
    public void severe(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.SEVERE, msgSupplier);
    }
    ...
    public void warning(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.WARNING, msgSupplier);
    }
    ...
    public void info(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.INFO, msgSupplier);
    }
    ...
    public void config(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.CONFIG, msgSupplier);
    }
    ...
    public void fine(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.FINE, msgSupplier);
    }
    ...
    public void finer(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.FINER, msgSupplier);
    }
    ...
    public void finest(Supplier<String> msgSupplier) {
        log(java.util.logging.Level.FINEST, msgSupplier);
    }
