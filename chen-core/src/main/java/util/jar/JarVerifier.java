...
class JarVerifier {
     ...
     */
    public void beginEntry(java.util.jar.JarEntry je, ManifestEntryVerifier mev)
        throws IOException
    {
        if (je == null)
            return;
        ...
        if (parsingMeta) {
            ...
            if ((uname.startsWith("META-INF/") ||
                ...
                if (uname.equals(java.util.jar.JarFile.MANIFEST_NAME) ||
        ...
        if (!name.equals(java.util.jar.JarFile.MANIFEST_NAME)) {
    ...
    {
        if (!parsingBlockOrSF) {
            java.util.jar.JarEntry je = mev.getEntry();
    ...
    public java.security.cert.Certificate[] getCerts(java.util.jar.JarFile jar, java.util.jar.JarEntry entry)
    {
    ...
    public CodeSigner[] getCodeSigners(java.util.jar.JarFile jar, java.util.jar.JarEntry entry)
    {
    ...
    void doneWithMeta()
    {
        ...
        if (sigFileSigners.containsKey(java.util.jar.JarFile.MANIFEST_NAME)) {
            CodeSigner[] codeSigners = sigFileSigners.remove(java.util.jar.JarFile.MANIFEST_NAME);
            verifiedSigners.put(java.util.jar.JarFile.MANIFEST_NAME, codeSigners);
        }
    }
    ...
    public synchronized Enumeration<String> entryNames(java.util.jar.JarFile jar, final CodeSource[] cs) {
     ...
     */
    public Enumeration<java.util.jar.JarEntry> entries2(final java.util.jar.JarFile jar, Enumeration<? extends ZipEntry> e) {
        ...
        return new Enumeration<java.util.jar.JarEntry>() {
            ...
            public java.util.jar.JarEntry nextElement() {
                if (hasMoreElements()) {
                    java.util.jar.JarEntry je = entry;
    ...
    private Enumeration<String> unsignedEntryNames(java.util.jar.JarFile jar) {
        final Map<String, CodeSigner[]> map = signerMap();
        final Enumeration<java.util.jar.JarEntry> entries = jar.entries();
        return new Enumeration<String>() {
    ...
    public synchronized CodeSource[] getCodeSources(java.util.jar.JarFile jar, URL url) {
