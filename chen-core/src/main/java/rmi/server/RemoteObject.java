...
public abstract class RemoteObject implements Remote, java.io.Serializable {
    ...
    transient protected java.rmi.server.RemoteRef ref;
     ...
     * as follows:
     *
     * <p>The {@link java.rmi.server.RemoteRef#getRefClass(java.io.ObjectOutput) getRefClass}
        ...
        throws java.io.IOException, ClassNotFoundException
    {
        ...
        if (refClassName == null || refClassName.length() == 0) {
             ...
             */
            ref = (java.rmi.server.RemoteRef) in.readObject();
        } else {
            /*
            ...
            String internalRefClassName =
                java.rmi.server.RemoteRef.packagePrefix + "." + refClassName;
