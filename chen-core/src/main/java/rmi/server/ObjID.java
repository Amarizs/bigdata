 ...
 * {@link java.rmi.server.UID}).  In a unique <code>ObjID</code>, the address space
 ...
 * equivalent to one returned by invoking the {@link java.rmi.server.UID#UID(short)}
...
public final class ObjID implements Serializable {
    ...
    private static final java.rmi.server.UID mySpace = new java.rmi.server.UID();
    ...
    public ObjID(int objNum) {
        space = new java.rmi.server.UID((short) 0);
        this.objNum = objNum;
    }
     ...
     */
    private ObjID(long objNum, java.rmi.server.UID space) {
        this.objNum = objNum;
        this.space = space;
    }
     ...
     * space identifier by invoking its {@link java.rmi.server.UID#write(DataOutput)}
     ...
     * then it invokes {@link java.rmi.server.UID#read(DataInput)} with the
    ...
    public static ObjID read(ObjectInput in) throws IOException {
        ...
        java.rmi.server.UID space = UID.read(in);
