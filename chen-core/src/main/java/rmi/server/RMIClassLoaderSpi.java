 ...
 * <ul>
 *
 * <li>{@link java.rmi.server.RMIClassLoader#loadClass(URL,String)}
 * <li>{@link java.rmi.server.RMIClassLoader#loadClass(String,String)}
 * <li>{@link java.rmi.server.RMIClassLoader#loadClass(String,String,ClassLoader)}
 * <li>{@link java.rmi.server.RMIClassLoader#loadProxyClass(String,String[],ClassLoader)}
 * <li>{@link java.rmi.server.RMIClassLoader#getClassLoader(String)}
 * <li>{@link java.rmi.server.RMIClassLoader#getClassAnnotation(Class)}
 *
 * </ul>
 *
 ...
 * See the documentation for {@link java.rmi.server.RMIClassLoader} for a description
...
public abstract class RMIClassLoaderSpi {
     ...
     * {@link java.rmi.server.RMIClassLoader#loadClass(URL,String)},
