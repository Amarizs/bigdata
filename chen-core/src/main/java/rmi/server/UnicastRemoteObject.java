 ...
 * class. The stub class must extend {@link java.rmi.server.RemoteStub} and must have a
 * public constructor that has one parameter of type {@link java.rmi.server.RemoteRef}.
 *
 * <li>Finally, an instance of the stub class is constructed with a
 * {@link java.rmi.server.RemoteRef}.
 *
 ...
 * object, {@link java.rmi.server.RMISocketFactory} may be used for creating sockets.
 * By default, server sockets created by {@link java.rmi.server.RMISocketFactory}
 * listen on all network interfaces. See the
 * {@link java.rmi.server.RMISocketFactory} class and the section
...
public class UnicastRemoteObject extends RemoteServer {
     ...
     * created using the {@link java.rmi.server.RMISocketFactory} class.
     *
     ...
     * {@link java.rmi.server.RMISocketFactory} is used instead.
     *
     * @param port the port number on which the remote object receives calls
     * (if <code>port</code> is zero, an anonymous port is chosen)
     ...
     */
    @Deprecated
    public static java.rmi.server.RemoteStub exportObject(Remote obj)
        throws RemoteException
    {
        /*
