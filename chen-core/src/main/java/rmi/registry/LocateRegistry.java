...
public final class LocateRegistry {
    ...
    {
        return getRegistry(null, java.rmi.registry.Registry.REGISTRY_PORT);
    }
     ...
     * @since JDK1.1
     */
    public static java.rmi.registry.Registry getRegistry(String host)
        throws RemoteException
    {
        return getRegistry(host, java.rmi.registry.Registry.REGISTRY_PORT);
    }
     ...
     * @since JDK1.1
     */
    public static java.rmi.registry.Registry getRegistry(String host, int port)
        throws RemoteException
    {
        ...
        throws RemoteException
    {
        ...
        return (java.rmi.registry.Registry) Util.createProxy(RegistryImpl.class, ref, false);
    }
     ...
     * @since JDK1.1
     **/
    public static java.rmi.registry.Registry createRegistry(int port) throws RemoteException {
