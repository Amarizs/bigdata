...
public class DecimalFormat extends java.text.NumberFormat {
    ...
    private void append(StringBuffer result, String string,
                        ...
                        java.text.Format.Field signAttribute) {
        ...
        if (string.length() > 0) {
            ...
            for (int counter = 0, max = positions.length; counter < max;
                ...
                java.text.Format.Field attribute = fp.getFieldAttribute();
    ...
    private final boolean subparse(String text, ParsePosition parsePosition,
                                   ...
                                   java.text.DigitList digits, boolean isExponent,
                                   boolean status[]) {
        ...
        if (!isExponent && text.regionMatches(position,symbols.getInfinity(),0,
            ...
            for (; position < text.length(); ++position) {
                ...
                if (digit == 0) {
                    ...
                    java.text.DigitList exponentDigits = new java.text.DigitList();
    ...
    public Object clone() {
        ...
        other.digitList = (java.text.DigitList) digitList.clone();
         ...
         throws IOException, ClassNotFoundException
    {
        ...
        digitList = new java.text.DigitList();
    ...
    private transient java.text.DigitList digitList = new java.text.DigitList();
