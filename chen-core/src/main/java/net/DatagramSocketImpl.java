...
public abstract class DatagramSocketImpl implements java.net.SocketOptions {
    ...
    void setDatagramSocket(java.net.DatagramSocket socket) {
        this.socket = socket;
    }
     ...
     * @since 1.4
     */
    protected void connect(java.net.InetAddress address, int port) throws SocketException {}
     ...
     */
    protected abstract void join(java.net.InetAddress inetaddr) throws IOException;
     ...
     * @since 1.4
     */
    protected abstract void joinGroup(java.net.SocketAddress mcastaddr,
    ...
    <T> void setOption(java.net.SocketOption<T> name, T value) throws IOException {
        if (name == StandardSocketOptions.SO_SNDBUF) {
            setOption(java.net.SocketOptions.SO_SNDBUF, value);
        } else if (name == StandardSocketOptions.SO_RCVBUF) {
            setOption(java.net.SocketOptions.SO_RCVBUF, value);
        } else if (name == StandardSocketOptions.SO_REUSEADDR) {
            setOption(java.net.SocketOptions.SO_REUSEADDR, value);
        } else if (name == StandardSocketOptions.IP_TOS) {
            setOption(java.net.SocketOptions.IP_TOS, value);
        } else if (name == StandardSocketOptions.IP_MULTICAST_IF &&
            (getDatagramSocket() instanceof java.net.MulticastSocket)) {
            setOption(java.net.SocketOptions.IP_MULTICAST_IF2, value);
            ...
            (getDatagramSocket() instanceof java.net.MulticastSocket)) {
            setOption(java.net.SocketOptions.IP_MULTICAST_LOOP, value);
        } else {
    ...
    <T> T getOption(SocketOption<T> name) throws IOException {
        if (name == StandardSocketOptions.SO_SNDBUF) {
            return (T) getOption(java.net.SocketOptions.SO_SNDBUF);
        } else if (name == StandardSocketOptions.SO_RCVBUF) {
            return (T) getOption(java.net.SocketOptions.SO_RCVBUF);
        } else if (name == StandardSocketOptions.SO_REUSEADDR) {
            return (T) getOption(java.net.SocketOptions.SO_REUSEADDR);
        } else if (name == StandardSocketOptions.IP_TOS) {
            return (T) getOption(java.net.SocketOptions.IP_TOS);
        } else if (name == StandardSocketOptions.IP_MULTICAST_IF &&
            (getDatagramSocket() instanceof java.net.MulticastSocket)) {
            return (T) getOption(java.net.SocketOptions.IP_MULTICAST_IF2);
        } else if (name == StandardSocketOptions.IP_MULTICAST_TTL &&
            (getDatagramSocket() instanceof java.net.MulticastSocket)) {
