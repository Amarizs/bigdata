...
public abstract class URLStreamHandler {
     ...
     *               connection.
     */
    abstract protected java.net.URLConnection openConnection(java.net.URL u) throws IOException;
     ...
     * @since      1.5
     */
    protected URLConnection openConnection(java.net.URL u, Proxy p) throws IOException {
...
// FIX: should not assume query if opaque
    ...
    protected synchronized java.net.InetAddress getHostAddress(java.net.URL u) {
        ...
        if (host == null || host.equals("")) {
            ...
            try {
                u.hostAddress = java.net.InetAddress.getByName(host);
    ...
    protected boolean hostsEqual(java.net.URL u1, java.net.URL u2) {
        java.net.InetAddress a1 = getHostAddress(u1);
     ...
     * @see     java.net.URL#set(String, String, int, String, String)
     * @since 1.3
     */
       protected void setURL(java.net.URL u, String protocol, String host, int port,
