...
class DatagramSocket implements java.io.Closeable {
     ...
     */
    java.net.InetAddress connectedAddress = null;
    int connectedPort = -1;
     ...
     */
    private synchronized void connectInternal(java.net.InetAddress address, int port) throws SocketException {
     ...
     * @since   1.4
     */
    public DatagramSocket(java.net.SocketAddress bindaddr) throws SocketException {
     ...
     * @since   JDK1.1
     */
    public DatagramSocket(int port, java.net.InetAddress laddr) throws SocketException {
            ...
            AccessController.doPrivileged(
                new PrivilegedExceptionAction<Void>() {
                    public Void run() throws NoSuchMethodException {
                        ...
                        cl[0] = java.net.DatagramPacket.class;
     ...
     * @since 1.4
     */
    public synchronized void bind(java.net.SocketAddress addr) throws SocketException {
        if (isClosed())
        ...
        java.net.InetAddress iaddr = epoint.getAddress();
     ...
     * @since 1.4
     */
    public void connect(java.net.SocketAddress addr) throws SocketException {
        if (addr == null)
     ...
     *
     * @see        java.net.DatagramPacket
     * @see        SecurityManager#checkMulticast(java.net.InetAddress)
     * @see        SecurityManager#checkConnect
     * @revised 1.4
     * @spec JSR-51
     */
    public void send(java.net.DatagramPacket p) throws IOException  {
        java.net.InetAddress packetAddress = null;
        synchronized (p) {
            if (isClosed())
                throw new SocketException("Socket is closed");
    ...
    public synchronized void receive(java.net.DatagramPacket p) throws IOException {
        synchronized (p) {
                ...
                if (security != null) {
                    while(true) {
                        ...
                        if (!oldImpl) {
                            ...
                            java.net.InetAddress adr = new java.net.InetAddress();
                        ...
                        try {
                            ...
                            // it in a tmp buffer.
                            java.net.DatagramPacket tmp = new java.net.DatagramPacket(new byte[1], 1);
                            getImpl().receive(tmp);
            ...
            java.net.DatagramPacket tmp = null;
            if ((connectState == ST_CONNECTED_NO_IMPL) || explicitFilter) {
                ...
                boolean stop = false;
                while (!stop) {
                    java.net.InetAddress peekAddress = null;
                    int peekPort = -1;
                    // peek at the packet to see who it is from.
                    if (!oldImpl) {
                        // We can use the new peekData() API
                        ...
                        peekAddress = new java.net.InetAddress();
                        peekPort = getImpl().peek(peekAddress);
                    }
                    if ((!connectedAddress.equals(peekAddress)) ||
                        (connectedPort != peekPort)) {
                        // throw the packet away and silently continue
                        tmp = new java.net.DatagramPacket(
                                                new byte[1024], 1024);
                        getImpl().receive(tmp);
                        if (explicitFilter) {
    ...
    private boolean checkFiltering(java.net.DatagramPacket p) throws SocketException {
    ...
    public java.net.InetAddress getLocalAddress() {
        if (isClosed())
            return null;
        java.net.InetAddress in = null;
        try {
            in = (java.net.InetAddress) getImpl().getOption(java.net.SocketOptions.SO_BINDADDR);
            if (in.isAnyLocalAddress()) {
                in = java.net.InetAddress.anyLocalAddress();
            }
    ...
    public synchronized void setSoTimeout(int timeout) throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_TIMEOUT, new Integer(timeout));
    }
    ...
    public synchronized int getSoTimeout() throws SocketException {
        ...
        if (getImpl() == null)
            return 0;
        Object o = getImpl().getOption(java.net.SocketOptions.SO_TIMEOUT);
        /* extra type safety */
    ...
    throws SocketException{
        ...
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_SNDBUF, new Integer(size));
    }
    ...
    public synchronized int getSendBufferSize() throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        int result = 0;
        Object o = getImpl().getOption(java.net.SocketOptions.SO_SNDBUF);
        if (o instanceof Integer) {
    ...
    throws SocketException{
        ...
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_RCVBUF, new Integer(size));
    }
    ...
    throws SocketException{
        if (isClosed())
            throw new SocketException("Socket is closed");
        int result = 0;
        Object o = getImpl().getOption(java.net.SocketOptions.SO_RCVBUF);
        if (o instanceof Integer) {
            result = ((Integer)o).intValue();
        }
        return result;
    ...
    public synchronized void setReuseAddress(boolean on) throws SocketException {
        ...
        if (oldImpl)
            getImpl().setOption(java.net.SocketOptions.SO_REUSEADDR, new Integer(on?-1:0));
        else
            getImpl().setOption(java.net.SocketOptions.SO_REUSEADDR, Boolean.valueOf(on));
    }
    ...
    public synchronized boolean getReuseAddress() throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        Object o = getImpl().getOption(java.net.SocketOptions.SO_REUSEADDR);
    ...
    public synchronized void setBroadcast(boolean on) throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_BROADCAST, Boolean.valueOf(on));
    }
    ...
    public synchronized boolean getBroadcast() throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        return ((Boolean)(getImpl().getOption(java.net.SocketOptions.SO_BROADCAST))).booleanValue();
    }
    ...
    public synchronized void setTrafficClass(int tc) throws SocketException {
        ...
        if (isClosed())
            throw new SocketException("Socket is closed");
        try {
            getImpl().setOption(java.net.SocketOptions.IP_TOS, tc);
        } catch (SocketException se) {
