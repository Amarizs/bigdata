    ...
    extends SocketAddress
{
    ...
    private static class InetSocketAddressHolder {
        ...
        private InetSocketAddressHolder(String hostname, java.net.InetAddress addr, int port) {
    ...
    public InetSocketAddress(int port) {
        this(java.net.InetAddress.anyLocalAddress(), port);
    }
    ...
    public InetSocketAddress(java.net.InetAddress addr, int port) {
        holder = new InetSocketAddressHolder(
                        null,
                        addr == null ? java.net.InetAddress.anyLocalAddress() : addr,
                        checkPort(port));
    }
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        final java.net.InetAddress oisAddr = (java.net.InetAddress)oisFields.get("addr", null);
