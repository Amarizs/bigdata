...
public final class StandardSocketOptions {
     ...
     * @see java.net.DatagramSocket#setBroadcast
     */
    public static final java.net.SocketOption<Boolean> SO_BROADCAST =
     ...
     */
    public static final java.net.SocketOption<Boolean> SO_KEEPALIVE =
     ...
     */
    public static final java.net.SocketOption<Integer> SO_SNDBUF =
     ...
     */
    public static final java.net.SocketOption<Integer> SO_RCVBUF =
     ...
     */
    public static final java.net.SocketOption<Boolean> SO_REUSEADDR =
     ...
     */
    public static final java.net.SocketOption<Integer> SO_LINGER =
     ...
     */
    public static final java.net.SocketOption<Integer> IP_TOS =
        new StdSocketOption<Integer>("IP_TOS", Integer.class);

    /**
     * The network interface for Internet Protocol (IP) multicast datagrams.
     *
     * <p> The value of this socket option is a {@link java.net.NetworkInterface} that
    ...
    public static final java.net.SocketOption<java.net.NetworkInterface> IP_MULTICAST_IF =
        new StdSocketOption<java.net.NetworkInterface>("IP_MULTICAST_IF", NetworkInterface.class);
     ...
     */
    public static final java.net.SocketOption<Integer> IP_MULTICAST_TTL =
     ...
     */
    public static final java.net.SocketOption<Boolean> IP_MULTICAST_LOOP =
     ...
     */
    public static final java.net.SocketOption<Boolean> TCP_NODELAY =
