...
public final class NetworkInterface {
    ...
    NetworkInterface(String name, int index, java.net.InetAddress[] addrs) {
        this.name = name;
        this.index = index;
        this.addrs = addrs;
    }
     ...
     * {@link java.net.NetPermission}("getNetworkInformation") permission, then all
     * InetAddresses are returned.
     * @return an Enumeration object with all or a subset of the InetAddresses
     * bound to this network interface
     */
    public Enumeration<java.net.InetAddress> getInetAddresses() {

        class checkedAddresses implements Enumeration<java.net.InetAddress> {

            private int i=0, count=0;
            private java.net.InetAddress local_addrs[];

            checkedAddresses() {
                local_addrs = new java.net.InetAddress[addrs.length];
                boolean trusted = true;

                SecurityManager sec = System.getSecurityManager();
                if (sec != null) {
                    try {
                        sec.checkPermission(new java.net.NetPermission("getNetworkInformation"));
    ...
    public java.util.List<java.net.InterfaceAddress> getInterfaceAddresses() {
        java.util.List<java.net.InterfaceAddress> lst = new java.util.ArrayList<InterfaceAddress>(1);
        SecurityManager sec = System.getSecurityManager();
     ...
     * @since 1.7
     */
    public static NetworkInterface getByIndex(int index) throws java.net.SocketException {
        if (index < 0)
     ...
     */
    public static NetworkInterface getByInetAddress(java.net.InetAddress addr) throws java.net.SocketException {
        if (addr == null) {
            throw new NullPointerException();
        }
        if (!(addr instanceof java.net.Inet4Address || addr instanceof Inet6Address)) {
    ...
    private native static NetworkInterface getByInetAddress0(java.net.InetAddress addr)
        throws java.net.SocketException;
    ...
    private native static boolean isUp0(String name, int ind) throws java.net.SocketException;
    private native static boolean isLoopback0(String name, int ind) throws java.net.SocketException;
    private native static boolean supportsMulticast0(String name, int ind) throws java.net.SocketException;
    private native static boolean isP2P0(String name, int ind) throws java.net.SocketException;
    private native static byte[] getMacAddr0(byte[] inAddr, String name, int ind) throws java.net.SocketException;
