...
class DualStackPlainSocketImpl extends java.net.AbstractPlainSocketImpl
{
    ...
    void socketAccept(SocketImpl s) throws IOException {
        ...
        int newfd = -1;
        java.net.InetSocketAddress[] isaa = new java.net.InetSocketAddress[1];
        if (timeout <= 0) {
        ...
        java.net.InetSocketAddress isa = isaa[0];
        s.port = isa.getPort();
    ...
    int socketGetOption(int opt, Object iaContainerObj) throws java.net.SocketException {
        int nativefd = checkAndReturnNativeFD();
    ...
    static native void bind0(int fd, java.net.InetAddress localAddress, int localport,
                             boolean exclBind)
        throws IOException;
    ...
    static native void localAddress(int fd, java.net.InetAddressContainer in) throws java.net.SocketException;
    ...
    static native void setIntOption(int fd, int cmd, int optionValue) throws java.net.SocketException;
