...
public abstract class JarURLConnection extends java.net.URLConnection {
    ...
    protected JarURLConnection(java.net.URL url) throws MalformedURLException {
        super(url);
        parseSpecs(url);
    }
     ...
     */
    private void parseSpecs(java.net.URL url) throws MalformedURLException {
        ...
        jarFileURL = new java.net.URL(spec.substring(0, separator++));
        entryName = null;
