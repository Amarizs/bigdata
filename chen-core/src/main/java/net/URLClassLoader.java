...
public class URLClassLoader extends SecureClassLoader implements Closeable {
    ...
    URLClassLoader(java.net.URL[] urls, ClassLoader parent,
    ...
    URLClassLoader(java.net.URL[] urls, AccessControlContext acc) {
        super();
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
    ...
    */
    ...
    // archive
    private void definePackageInternal(String pkgname, Manifest man, java.net.URL url)
    {
    ...
    private Class<?> defineClass(String name, Resource res) throws IOException {
        ...
        java.net.URL url = res.getCodeSourceURL();
        if (i != -1) {
     ...
     */
    public java.net.URL findResource(final String name) {
        /*
         * The same restriction to finding classes applies to resources
         */
        java.net.URL url = AccessController.doPrivileged(
            new PrivilegedAction<java.net.URL>() {
     ...
     */
    public Enumeration<java.net.URL> findResources(final String name)
        throws IOException
    {
        final Enumeration<java.net.URL> e = ucp.findResources(name, true);

        return new Enumeration<java.net.URL>() {
            ...
            private boolean next() {
                ...
                do {
                    java.net.URL u = AccessController.doPrivileged(
                        new PrivilegedAction<java.net.URL>() {
                            public java.net.URL run() {
     ...
     */
    public static URLClassLoader newInstance(final java.net.URL[] urls,
...
final class FactoryURLClassLoader extends URLClassLoader {
    ...
    FactoryURLClassLoader(java.net.URL[] urls, ClassLoader parent,
                          AccessControlContext acc) {
