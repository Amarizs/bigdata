...
class Socket implements java.io.Closeable {
    ...
    public Socket(java.net.Proxy proxy) {
        ...
        java.net.Proxy p = proxy == java.net.Proxy.NO_PROXY ? java.net.Proxy.NO_PROXY
                                          : sun.net.ApplicationProxy.create(proxy);
        java.net.Proxy.Type type = p.type();
        if (type == java.net.Proxy.Type.SOCKS || type == java.net.Proxy.Type.HTTP) {
            ...
            impl = type == java.net.Proxy.Type.SOCKS ? new SocksSocketImpl(p)
