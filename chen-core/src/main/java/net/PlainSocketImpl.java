...
class PlainSocketImpl extends AbstractPlainSocketImpl
{
    ...
    protected synchronized void accept(java.net.SocketImpl s) throws IOException {
        if (s instanceof PlainSocketImpl) {
            // pass in the real impl not the wrapper.
            java.net.SocketImpl delegate = ((PlainSocketImpl)s).impl;
            delegate.address = new java.net.InetAddress();
