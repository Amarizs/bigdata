...
class ServerSocket implements java.io.Closeable {
     ...
     * @since   JDK1.1
     */
    public ServerSocket(int port, int backlog, java.net.InetAddress bindAddr) throws IOException {
        setImpl();
     ...
     * @since 1.4
     */
    java.net.SocketImpl getImpl() throws SocketException {
        if (!created)
            createImpl();
        return impl;
    }
    ...
    public java.net.InetAddress getInetAddress() {
        if (!isBound())
            return null;
        try {
            java.net.InetAddress in = getImpl().getInetAddress();
    ...
    public java.net.Socket accept() throws IOException {
        ...
        java.net.Socket s = new java.net.Socket((java.net.SocketImpl) null);
        implAccept(s);
        return s;
    }
     ...
     * @spec JSR-51
     */
    protected final void implAccept(java.net.Socket s) throws IOException {
        SocketImpl si = null;
        try {
            if (s.impl == null)
              s.setImpl();
            ...
            si = s.impl;
            s.impl = null;
            si.address = new java.net.InetAddress();
