...
class SignedMutableBigInteger extends java.math.MutableBigInteger {
   ...
   /**
     ...
     */
    SignedMutableBigInteger(java.math.MutableBigInteger val) {
        super(val);
    }
   ...
   /**
     * Signed addition built upon unsigned add and subtract.
     */
    void signedAdd(java.math.MutableBigInteger addend) {
        if (sign == 1)
            add(addend);
        else
            sign = sign * subtract(addend);
   ...
   /**
     * Signed subtraction built upon unsigned add and subtract.
     */
    void signedSubtract(java.math.MutableBigInteger addend) {
        if (sign == 1)
            sign = sign * subtract(addend);
        else
            add(addend);
