...
abstract class TexturePaintContext implements java.awt.PaintContext {
    ...
    public static PaintContext getContext(BufferedImage bufImg,
        ...
        Object val = hints.get(java.awt.RenderingHints.KEY_INTERPOLATION);
        boolean filter =
            (val == null
             ? (hints.get(java.awt.RenderingHints.KEY_RENDERING) == java.awt.RenderingHints.VALUE_RENDER_QUALITY)
