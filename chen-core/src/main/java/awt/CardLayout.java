...
public class CardLayout implements LayoutManager2,
    ...
    class Card implements Serializable {
        ...
        public Card(String cardName, java.awt.Component cardComponent) {
            name = cardName;
            comp = cardComponent;
        }
    }
    ...
    */
     ...
     *                                        card in the layout.
     * @see       java.awt.CardLayout#show(java.awt.Container, String)
    ...
    public java.awt.Dimension preferredLayoutSize(java.awt.Container parent) {
        synchronized (parent.getTreeLock()) {
            ...
            return new java.awt.Dimension(insets.left + insets.right + w + hgap*2,
     ...
     * @see       java.awt.CardLayout#addLayoutComponent(java.awt.Component, Object)
     */
        ...
        throws ClassNotFoundException, IOException
    {
        ...
        if (f.defaulted("vector")) {
            //  pre-1.4 stream
            Hashtable<String, java.awt.Component> tab = (Hashtable)f.get("tab", null);
            vector = new Vector<>();
