...
public final class SplashScreen {
    ...
    /**
     * Returns the bounds of the splash screen window as a {@link java.awt.Rectangle}.
     ...
     * @throws IllegalStateException if the splash screen has already been closed
     */
    public java.awt.Rectangle getBounds() throws IllegalStateException {
        synchronized (SplashScreen.class) {
            checkVisible();
            float scale = _getScaleFactor(splashPtr);
            java.awt.Rectangle bounds = _getBounds(splashPtr);
            assert scale > 0;
            if (scale > 0 && scale != 1) {
    ...
    /**
     * Returns the size of the splash screen window as a {@link java.awt.Dimension}.
     ...
     * be larger than the visible splash screen image on the screen.
     *
     * @return a {@link java.awt.Dimension} object indicating the splash screen size
     * @throws IllegalStateException if the splash screen has already been closed
     */
    public java.awt.Dimension getSize() throws IllegalStateException {
        return getBounds().getSize();
    }

    /**
     * Creates a graphics context (as a {@link java.awt.Graphics2D} object) for the splash
     ...
     * @throws IllegalStateException if the splash screen has already been closed
     */
    public java.awt.Graphics2D createGraphics() throws IllegalStateException {
        synchronized (SplashScreen.class) {
            checkVisible();
            if (image==null) {
