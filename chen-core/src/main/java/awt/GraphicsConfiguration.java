...
public abstract class GraphicsConfiguration {
     ...
     * @see java.awt.GraphicsDevice#getBestConfiguration
    ...
    /**
     * Returns the {@link java.awt.GraphicsDevice} associated with this
    ...
    public VolatileImage createCompatibleVolatileImage(int width, int height) {
        ...
        try {
            vi = createCompatibleVolatileImage(width, height,
                                               null, java.awt.Transparency.OPAQUE);
     ...
     * @exception java.awt.AWTException if the supplied image capabilities could not
     * be met by this graphics configuration
     * @since 1.4
     */
    public VolatileImage createCompatibleVolatileImage(int width, int height,
        java.awt.ImageCapabilities caps) throws java.awt.AWTException
    {
     ...
     */
    public VolatileImage createCompatibleVolatileImage(int width, int height,
                                                       java.awt.ImageCapabilities caps, int transparency) throws java.awt.AWTException
    {
        VolatileImage vi =
