...
public class Container extends java.awt.Component {
     ...
     * @see #getComponents
     */
    private java.util.List<java.awt.Component> component = new ArrayList<>();
    ...
    private static final ObjectStreamField[] serialPersistentFields = {
        ...
        new ObjectStreamField("component", java.awt.Component[].class),
    ...
    static {
        ...
        AWTAccessor.setContainerAccessor(new AWTAccessor.ContainerAccessor() {
            ...
            @Override
            public java.awt.Component findComponentAt(Container cont, int x, int y,
     ...
     * @see       #getComponent
     * @since     JDK1.1
     * @see java.awt.Component#getTreeLock()
     */
     ...
     * @since: 1.5
     */
    private boolean removeDelicately(java.awt.Component comp, Container newParent, int newIndex) {
        checkTreeLock();
        ...
        if (newParent != this) {
            ...
            adjustListeningChildren(java.awt.AWTEvent.HIERARCHY_EVENT_MASK,
                                    -comp.numListening(java.awt.AWTEvent.HIERARCHY_EVENT_MASK));
            adjustListeningChildren(java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK,
                                    -comp.numListening(java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK));
        ...
        if (comp.parent == null) { // was actually removed
            if (containerListener != null ||
                (eventMask & java.awt.AWTEvent.CONTAINER_EVENT_MASK) != 0 ||
                java.awt.Toolkit.enabledOnToolkit(java.awt.AWTEvent.CONTAINER_EVENT_MASK)) {
            ...
            comp.createHierarchyEvents(HierarchyEvent.HIERARCHY_CHANGED, comp,
                                       ...
                                       java.awt.Toolkit.enabledOnToolkit(java.awt.AWTEvent.HIERARCHY_EVENT_MASK));
     ...
     * @since: 1.5
     */
    private static boolean isRemoveNotifyNeeded(java.awt.Component comp, Container oldContainer, Container newContainer) {
     ...
     * @since 1.5
     */
    private void addDelicately(java.awt.Component comp, Container curParent, int index) {
        checkTreeLock();
     ...
     * {@link LayoutManager2#addLayoutComponent(java.awt.Component,Object)} is invoked on
     * it. If the current layout manager does not implement
     * {@code LayoutManager2}, and constraints is a {@code String}, then
     * {@link LayoutManager#addLayoutComponent(String, java.awt.Component)} is invoked on it.
     * <p>
    ...
    void adjustListeningChildren(long mask, int num) {
        if (eventLog.isLoggable(PlatformLogger.Level.FINE)) {
            boolean toAssert = (mask == java.awt.AWTEvent.HIERARCHY_EVENT_MASK ||
                                mask == java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK ||
                                mask == (java.awt.AWTEvent.HIERARCHY_EVENT_MASK |
    ...
    final int createHierarchyEvents(int id, java.awt.Component changed,
     ...
     * ancestors. See the {@link java.awt.Component#invalidate} method for more details.
     *
     * @see #validate
     * @see #layout
     * @see LayoutManager2
     ...
     * invalidated also (see {@link java.awt.Component#invalidate} for details.)
    ...
    protected void validateTree() {
        ...
        if (!isValid() || descendUnconditionallyWhenValidating) {
            ...
            for (int i = 0; i < component.size(); i++) {
                ...
                if (   (comp instanceof Container)
                       && !(comp instanceof java.awt.Window)
                       && (!comp.isValid() ||
     ...
     * not been set explicitly by {@link java.awt.Component#setPreferredSize(Dimension)}
     ...
     * not been set explicitly by {@link java.awt.Component#setMinimumSize(Dimension)}
     * and this {@code Container} has a {@code non-null} {@link LayoutManager},
     ...
     * not been set explicitly by {@link java.awt.Component#setMaximumSize(Dimension)}
    ...
    boolean eventEnabled(java.awt.AWTEvent e) {
        ...
        if (id == ContainerEvent.COMPONENT_ADDED ||
            ...
            if ((eventMask & java.awt.AWTEvent.CONTAINER_EVENT_MASK) != 0 ||
            ...
            switch (e.getID()) {
              case ComponentEvent.COMPONENT_RESIZED:
                createChildHierarchyEvents(HierarchyEvent.ANCESTOR_RESIZED, 0,
                                           java.awt.Toolkit.enabledOnToolkit(java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK));
                break;
     ...
     */
    private java.awt.Component getMouseEventTarget(int x, int y, boolean includeSelf,
     ...
     *        the search.
     */
    private java.awt.Component getMouseEventTargetImpl(int x, int y, boolean includeSelf,
                                                       EventTargetFilter filter,
            ...
            for (int i = 0; i < component.size(); i++) {
                ...
                if (comp != null && comp.visible &&
                    ...
                    if (comp instanceof Container) {
                        ...
                        java.awt.Component deeper = child.getMouseEventTarget(
                                x - child.x,
                                y - child.y,
                                includeSelf,
                                filter,
    ...
    static class MouseEventTargetFilter implements EventTargetFilter {
        ...
        public boolean accept(final java.awt.Component comp) {
            return (comp.eventMask & java.awt.AWTEvent.MOUSE_MOTION_EVENT_MASK) != 0
                || (comp.eventMask & java.awt.AWTEvent.MOUSE_EVENT_MASK) != 0
                || (comp.eventMask & java.awt.AWTEvent.MOUSE_WHEEL_EVENT_MASK) != 0
     ...
     * This method is similar to {@link java.awt.Component#getMousePosition()} with the exception
     ...
     * @since     1.5
     */
    public java.awt.Point getMousePosition(boolean allowChildren) throws HeadlessException {
        if (GraphicsEnvironment.isHeadless()) {
    ...
    final java.awt.Component findComponentAtImpl(int x, int y, boolean ignoreEnabled) {
        ...
        for (final java.awt.Component comp : component) {
            ...
            if (!comp.isLightweight()) {
                final java.awt.Component child = getChildAt(comp, x1, y1, ignoreEnabled);
                if (child != null) {
                    // return heavyweight component as soon as possible
                    return child;
                }
     ...
     */
    private static java.awt.Component getChildAt(java.awt.Component comp, int x, int y,
                                                 boolean ignoreEnabled) {
        if (comp instanceof Container) {
    ...
    private void startLWModal() {
        ...
        java.awt.Component predictedFocusOwner = (java.awt.Component.isInstanceOf(this, "javax.swing.JInternalFrame")) ? ((javax.swing.JInternalFrame)(this)).getMostRecentFocusOwner() : null;
     ...
     * @see      java.awt.Component#list(PrintStream, int)
     * @since    JDK1.0
     */
     ...
     * @param    indent   the number of spaces to indent
     * @throws   NullPointerException if {@code out} is {@code null}
     * @see      java.awt.Component#list(PrintWriter, int)
     * @since    JDK1.1
     */
    ...
    final boolean containsFocus() {
        final java.awt.Component focusOwner = KeyboardFocusManager.
    ...
    private boolean isParentOf(java.awt.Component comp) {
        synchronized(getTreeLock()) {
            while (comp != null && comp != this && !(comp instanceof java.awt.Window)) {
                comp = comp.getParent();
            }
            return (comp == this);
        }
    ...
    void clearMostRecentFocusOwnerOnHide() {
        ...
        synchronized (getTreeLock()) {
            ...
            if (window != null) {
                java.awt.Component comp = KeyboardFocusManager.getMostRecentFocusOwner(window);
    ...
    public void transferFocusDownCycle() {
        if (isFocusCycleRoot()) {
            ...
            java.awt.Component toFocus = getFocusTraversalPolicy().
     ...
     *
     * @see java.awt.Component#removePropertyChangeListener
        ...
        throws ClassNotFoundException, IOException
    {
        ...
        java.awt.Component[] tmpComponent = (java.awt.Component[])f.get("component", null);
        ...
        component = new ArrayList<java.awt.Component>(ncomponents);
        ...
        java.util.List<java.awt.Component> component = this.component;
        for(java.awt.Component comp : component) {
            comp.parent = this;
            adjustListeningChildren(java.awt.AWTEvent.HIERARCHY_EVENT_MASK,
                                    comp.numListening(java.awt.AWTEvent.HIERARCHY_EVENT_MASK));
    ...
    Accessible getAccessibleAt(java.awt.Point p) {
        synchronized (getTreeLock()) {
            if (this instanceof Accessible) {
                        ...
                        if ((a != null)) {
                            ...
                            if (ac != null) {
                                ...
                                if ((acmp != null) && (acmp.isShowing())) {
                                    ...
                                    java.awt.Point np = new java.awt.Point(p.x-location.x,
                                                         p.y-location.y);
                                    if (acmp.contains(np)){
                                        return a;
                                    }
                ...
                java.awt.Component ret = this;
                if (!this.contains(p.x,p.y)) {
                    ret = null;
                } else {
                    int ncomponents = this.getComponentCount();
                    for (int i=0; i < ncomponents; i++) {
                        java.awt.Component comp = this.getComponent(i);
...
class LightweightDispatcher implements java.io.Serializable, AWTEventListener {
    ...
    private boolean processMouseEvent(MouseEvent e) {
        int id = e.getID();
        java.awt.Component mouseOver =   // sensitive to mouse events
    ...
    private boolean processDropTargetEvent(SunDropTargetEvent e) {
        ...
        java.awt.Component mouseOver =   // not necessarily sensitive to mouse events
     ...
     */
    private void trackDropTargetEnterExit(java.awt.Component targetOver, MouseEvent e) {
        int id = e.getID();
        ...
        java.awt.Component tle = retargetMouseEnterExit(targetOver, e,
     ...
     */
    private void trackMouseEnterExit(java.awt.Component targetOver, MouseEvent e) {
        if (e instanceof SunDropTargetEvent) {
    ...
    private java.awt.Component retargetMouseEnterExit(java.awt.Component targetOver, MouseEvent e,
                                                      java.awt.Component lastEntered,
     ...
     * message.
     */
    void retargetMouseEvent(java.awt.Component target, int id, MouseEvent e) {
        if (target == null) {
     ...
     * a subcomponent.
     */
    private transient WeakReference<java.awt.Component> mouseEventTarget;

    /**
     * The last component entered by the {@code MouseEvent}.
     */
    private transient  WeakReference<java.awt.Component> targetLastEntered;
