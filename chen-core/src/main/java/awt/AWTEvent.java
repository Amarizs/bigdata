    ...
    java.awt.Event convertToOld() {
        ...
        switch(id) {
          ...
          case KeyEvent.KEY_RELEASED:
              ...
              if (ke.isActionKey()) {
                  newid = (id == KeyEvent.KEY_PRESSED?
                           java.awt.Event.KEY_ACTION : java.awt.Event.KEY_ACTION_RELEASE);
              }
              ...
              return new java.awt.Event(src, ke.getWhen(), newid, 0, 0,
                               java.awt.Event.getOldEventKey(ke),
          ...
          case MouseEvent.MOUSE_EXITED:
              ...
              // no mask for button1 existed in old Event - strip it out
              java.awt.Event olde = new java.awt.Event(src, me.getWhen(), newid,
                               me.getX(), me.getY(), 0,
          ...
          case ItemEvent.ITEM_STATE_CHANGED:
              ...
              if (src instanceof List) {
                  newid = (ie.getStateChange() == ItemEvent.SELECTED?
                           java.awt.Event.LIST_SELECT : java.awt.Event.LIST_DESELECT);
                  arg = ie.getItem();
              } else {
