...
public abstract class MenuComponent implements java.io.Serializable {
     ...
     * @serial
     * @see #dispatchEvent(java.awt.AWTEvent)
     */
     ...
     */
    final static String actionListenerK = java.awt.Component.actionListenerK;
    final static String itemListenerK = java.awt.Component.itemListenerK;
    ...
    static {
        AWTAccessor.setMenuComponentAccessor(
            new AWTAccessor.MenuComponentAccessor() {
                ...
                public java.awt.Font getFont_NoClientCode(MenuComponent menuComp) {
     ...
     * @see       #getFont
     * @see       java.awt.Font#getAttributes
    ...
    public void removeNotify() {
        synchronized (getTreeLock()) {
            ...
            if (p != null) {
                java.awt.Toolkit.getEventQueue().removeSourceEvents(this, true);
                this.peer = null;
                p.dispose();
            }
        }
     ...
     * #dispatchEvent(java.awt.AWTEvent) dispatchEvent}.
     */
    @Deprecated
