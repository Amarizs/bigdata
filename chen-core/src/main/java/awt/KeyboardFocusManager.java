...
public abstract class KeyboardFocusManager
    implements java.awt.KeyEventDispatcher, KeyEventPostProcessor
{
    ...
    static {
        ...
        AWTAccessor.setKeyboardFocusManagerAccessor(
            new AWTAccessor.KeyboardFocusManagerAccessor() {
                public int shouldNativelyFocusHeavyweight(java.awt.Component heavyweight,
                ...
                public boolean processSynchronousLightweightTransfer(java.awt.Component heavyweight,
                                                                     java.awt.Component descendant,
                                                                     boolean temporary,
                                                                     boolean focusedWindowChangeAllowed,
                                                                     long time)
    ...
    private static final java.awt.AWTKeyStroke[][] defaultFocusTraversalKeyStrokes = {
        {
            java.awt.AWTKeyStroke.getAWTKeyStroke(KeyEvent.VK_TAB, 0, false),
            java.awt.AWTKeyStroke.getAWTKeyStroke(KeyEvent.VK_TAB, InputEvent.CTRL_DOWN_MASK | InputEvent.CTRL_MASK, false),
        },
        {
            java.awt.AWTKeyStroke.getAWTKeyStroke(KeyEvent.VK_TAB, InputEvent.SHIFT_DOWN_MASK | InputEvent.SHIFT_MASK, false),
            java.awt.AWTKeyStroke.getAWTKeyStroke(KeyEvent.VK_TAB,
     ...
     * set.
     */
    private Set<java.awt.AWTKeyStroke>[] defaultFocusTraversalKeys = new Set[4];
     ...
     * a List of length 0.
     */
    private LinkedList<java.awt.KeyEventDispatcher> keyEventDispatchers;
     ...
     */
    private static java.util.Map<java.awt.Window, WeakReference<java.awt.Component>> mostRecentFocusOwners = new WeakHashMap<>();
    ...
    static Set<java.awt.AWTKeyStroke> initFocusTraversalKeysSet(String value, Set<java.awt.AWTKeyStroke> targetSet) {
    ...
    public KeyboardFocusManager() {
        for (int i = 0; i < TRAVERSAL_KEY_LENGTH; i++) {
            Set<java.awt.AWTKeyStroke> work_set = new HashSet<>();
     ...
     *         permission
     */
    protected java.awt.Component getGlobalFocusOwner() throws SecurityException {
        synchronized (KeyboardFocusManager.class) {
            checkKFMSecurity();
            return focusOwner;
        }
    ...
    private void _clearGlobalFocusOwner() {
        java.awt.Window activeWindow = markClearGlobalFocusOwner();
     ...
     *         permission
     */
    protected java.awt.Window getGlobalFocusedWindow() throws SecurityException {
        synchronized (KeyboardFocusManager.class) {
            checkKFMSecurity();
     ...
     *         permission
     */
    protected java.awt.Window getGlobalActiveWindow() throws SecurityException {
        synchronized (KeyboardFocusManager.class) {
            checkKFMSecurity();
            return activeWindow;
        }
    ...
    public void
        setDefaultFocusTraversalKeys(int id,
                                     Set<? extends java.awt.AWTKeyStroke> keystrokes)
    {
        ...
        Set<java.awt.AWTKeyStroke> oldKeys;
     ...
     * is thrown.
     * <p>
     * In a multithreaded application, {@link java.awt.KeyEventDispatcher} behaves
     ...
     * @see #removeKeyEventDispatcher
     */
    protected synchronized java.util.List<java.awt.KeyEventDispatcher>
    ...
    static void setMostRecentFocusOwner(java.awt.Component component) {
        ...
        if (window != null) {
            setMostRecentFocusOwner((java.awt.Window)window, component);
        }
    }
    static synchronized void setMostRecentFocusOwner(java.awt.Window window,
        ...
        WeakReference<java.awt.Component> weakValue = null;
        if (component != null) {
    ...
    static void clearMostRecentFocusOwner(java.awt.Component comp) {
        ...
        synchronized (KeyboardFocusManager.class) {
            if ((window != null)
                && (getMostRecentFocusOwner((java.awt.Window)window) == comp))
            {
                setMostRecentFocusOwner((java.awt.Window)window, null);
            }
    ...
    static synchronized java.awt.Component getMostRecentFocusOwner(java.awt.Window window) {
        WeakReference<java.awt.Component> weakValue =
    ...
    private static final class LightweightFocusRequest {
        ...
        LightweightFocusRequest(java.awt.Component component, boolean temporary, CausedFocusEvent.Cause cause) {
    ...
    private static final class HeavyweightFocusRequest {
        ...
        HeavyweightFocusRequest(java.awt.Component heavyweight, java.awt.Component descendant,
        ...
        boolean addLightweightRequest(java.awt.Component descendant,
                                      boolean temporary, CausedFocusEvent.Cause cause) {
            if (log.isLoggable(PlatformLogger.Level.FINE)) {
            ...
            java.awt.Component lastDescendant = ((lightweightRequests.size() > 0)
    ...
    static boolean processSynchronousLightweightTransfer(java.awt.Component heavyweight, java.awt.Component descendant,
                                                         boolean temporary, boolean focusedWindowChangeAllowed,
                                                         long time)
    {
        java.awt.Window parentWindow = SunToolkit.getContainingWindow(heavyweight);
    ...
    static int shouldNativelyFocusHeavyweight
        (java.awt.Component heavyweight, java.awt.Component descendant, boolean temporary,
    ...
    static java.awt.Window markClearGlobalFocusOwner() {
        ...
        // see 6454631.
        final java.awt.Component nativeFocusedWindow =
        ...
        synchronized (heavyweightRequests) {
            ...
            java.awt.Component activeWindow = ((hwFocusRequest != null)
     ...
     */
    static private Throwable dispatchAndCatchException(Throwable ex, java.awt.Component comp, FocusEvent event) {
    ...
    static FocusEvent retargetFocusGained(FocusEvent fe) {
        ...
        java.awt.Component currentFocusOwner = getCurrentKeyboardFocusManager().
            getGlobalFocusOwner();
        java.awt.Component source = fe.getComponent();
        java.awt.Component opposite = fe.getOppositeComponent();
        java.awt.Component nativeSource = getHeavyweight(source);
    ...
    static FocusEvent retargetFocusLost(FocusEvent fe) {
        ...
        java.awt.Component currentFocusOwner = getCurrentKeyboardFocusManager().
            getGlobalFocusOwner();
        java.awt.Component opposite = fe.getOppositeComponent();
        java.awt.Component nativeOpposite = getHeavyweight(opposite);
    ...
    static java.awt.AWTEvent retargetFocusEvent(AWTEvent event) {
    ...
    private static boolean focusedWindowChanged(java.awt.Component to, java.awt.Component from) {
        java.awt.Window wto = SunToolkit.getContainingWindow(to);
        java.awt.Window wfrom = SunToolkit.getContainingWindow(from);
    ...
    static java.awt.Component getHeavyweight(Component comp) {
