...
public abstract class Toolkit {
     ...
     * @since     1.4
     */
    public java.awt.Insets getScreenInsets(GraphicsConfiguration gc)
        throws HeadlessException {
        GraphicsEnvironment.checkHeadless();
        if (this != Toolkit.getDefaultToolkit()) {
     ...
     * calling the {@link java.awt.Image#flush flush} method on the
     ...
     * @see       Component#prepareImage(java.awt.Image,
     *                 ImageObserver)
     * @see       Component#prepareImage(java.awt.Image,
     *                 int, int, ImageObserver)
     * @see       ImageObserver
     */
    public abstract boolean prepareImage(java.awt.Image image, int width, int height,
     ...
     *                 int, int, ImageObserver)
     * @see       Component#checkImage(java.awt.Image,
     *                 ImageObserver)
     * @see       Component#checkImage(java.awt.Image,
     *                 int, int, ImageObserver)
     * @see       ImageObserver
     ...
     * @since   JDK1.1
     */
    public abstract PrintJob getPrintJob(java.awt.Frame frame, String jobtitle,
                                         Properties props);
     ...
     * @since   1.3
     */
    public PrintJob getPrintJob(java.awt.Frame frame, String jobtitle,
        ...
        throws IndexOutOfBoundsException, HeadlessException
    {
        ...
        if (this != Toolkit.getDefaultToolkit()) {
            ...
            return new java.awt.Cursor(Cursor.DEFAULT_CURSOR);
        }
    }
     ...
     * documentation for the {@link java.awt.Frame#setExtendedState} method.
     * </ul>
     *
    ...
    */
     ...
     * particular Window, use {@link java.awt.Window#isAlwaysOnTopSupported}.
     * @return <code>true</code>, if current toolkit supports the always-on-top mode,
     *     otherwise returns <code>false</code>
     * @see java.awt.Window#isAlwaysOnTopSupported
