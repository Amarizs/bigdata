...
java.io.Serializable {
     ...
     * @see GridBagConstraints
     */
    protected Hashtable<java.awt.Component,GridBagConstraints> comptable;
     ...
     *
     * @serial
     * @see #getConstraints(java.awt.Component)
     * @see #setConstraints(java.awt.Component, GridBagConstraints)
     * @see #lookupConstraints(java.awt.Component)
     */
     ...
     *
     * @serial
     * @see #getLayoutInfo(java.awt.Container, int)
     */
    ...
    public GridBagLayout () {
        comptable = new Hashtable<java.awt.Component,GridBagConstraints>();
     ...
     */
    public void setConstraints(java.awt.Component comp, GridBagConstraints constraints) {
     ...
     *                  object is returned
     */
    public GridBagConstraints getConstraints(java.awt.Component comp) {
     ...
     */
    protected GridBagConstraints lookupConstraints(java.awt.Component comp) {
        GridBagConstraints constraints = comptable.get(comp);
        if (constraints == null) {
            setConstraints(comp, defaultConstraints);
            constraints = comptable.get(comp);
     ...
     * @param       comp the component to be modified
     */
    private void removeConstraints(java.awt.Component comp) {
    ...
    public java.awt.Point location(int x, int y) {
        java.awt.Point loc = new Point(0,0);
        int i, d;
     ...
     * @since 1.4
     */
    protected GridBagLayoutInfo getLayoutInfo(java.awt.Container parent, int sizeflag) {
                ...
                if (hasBaseline) {
                    ...
                    case GridBagConstraints.BASELINE_TRAILING:
                        if (constraints.ascent >= 0) {
                            ...
                            if (constraints.baselineResizeBehavior ==
                                    java.awt.Component.BaselineResizeBehavior.CONSTANT_DESCENT) {
     ...
     */
    private boolean calculateBaseline(java.awt.Component c,
                                      GridBagConstraints constraints,
        ...
        if (anchor == GridBagConstraints.BASELINE ||
            ...
            if (constraints.ascent >= 0) {
                ...
                if (constraints.baselineResizeBehavior == java.awt.Component.
     ...
     * This method is obsolete and supplied for backwards
     * compatibility only; new code should call {@link
     * #adjustForGravity(GridBagConstraints, java.awt.Rectangle)
     ...
     *        ipady
     */
    private void alignOnBaseline(GridBagConstraints cons, java.awt.Rectangle r,
                                 int cellY, int cellHeight) {
        if (cons.ascent >= 0) {
            if (cons.baselineResizeBehavior == java.awt.Component.
     ...
     */
    private void alignAboveBaseline(GridBagConstraints cons, java.awt.Rectangle r,
                                    int cellY, int cellHeight) {
     ...
     */
    private void alignBelowBaseline(GridBagConstraints cons, java.awt.Rectangle r,
                                    int cellY, int cellHeight) {
        if (layoutInfo.hasBaseline(cons.tempY)) {
            if (layoutInfo.hasConstantDescent(cons.tempY)) {
                // Prefer descent
    ...
    private void centerVertically(GridBagConstraints cons, java.awt.Rectangle r,
                                  int cellHeight) {
        if (!cons.isVerticallyResizable()) {
     ...
     * @since 1.4
     */
    protected java.awt.Dimension getMinSize(java.awt.Container parent, GridBagLayoutInfo info) {
        return GetMinSize(parent, info);
    }
     ...
     * This method is obsolete and supplied for backwards
     * compatibility only; new code should call {@link
     * #arrangeGrid(java.awt.Container) arrangeGrid} instead.
