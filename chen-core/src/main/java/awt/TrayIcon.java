...
public class TrayIcon {
     ...
     * @see TrayIcon#TrayIcon(java.awt.Image, String, PopupMenu)
     * @see TrayIcon#TrayIcon(java.awt.Image, String)
     ...
     * is not granted
     * @see SystemTray#add(TrayIcon)
     * @see TrayIcon#TrayIcon(java.awt.Image)
     * @see TrayIcon#TrayIcon(java.awt.Image, String, PopupMenu)
     * @see SecurityManager#checkPermission
     * @see AWTPermission
     */
     ...
     * @see AWTPermission
     */
    public TrayIcon(java.awt.Image image, String tooltip, PopupMenu popup) {
        this(image, tooltip);
        setPopupMenu(popup);
    }
        ...
        synchronized (this) {
            if (peer == null) {
                ...
                if (toolkit instanceof SunToolkit) {
                    peer = ((SunToolkit) java.awt.Toolkit.getDefaultToolkit()).createTrayIcon(this);
                } else if (toolkit instanceof HeadlessToolkit) {
                    peer = ((HeadlessToolkit) java.awt.Toolkit.getDefaultToolkit()).createTrayIcon(this);
                }
            }
        }
        peer.setToolTip(tooltip);
