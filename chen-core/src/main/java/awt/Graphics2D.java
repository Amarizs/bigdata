 ...
 * {@link java.awt.Graphics} class to provide more sophisticated
 ...
 * {@link Component} or {@link java.awt.Image}).  This default transform maps the
 ...
 * The <code>Clip</code> is specified by a {@link java.awt.Shape} in user
 ...
 * {@link java.awt.Composite} attribute in the <code>Graphics2D</code> context.
 * </ol>
 * <br>
 ...
 * the  {@link java.awt.Stroke#createStrokedShape(java.awt.Shape) createStrokedShape}
 * method on the current {@link java.awt.Stroke} attribute in the
 ...
 * {@link java.awt.Shape#getPathIterator(AffineTransform) getPathIterator} method of
 ...
 * alternate
 * {@link java.awt.Shape#getPathIterator(AffineTransform, double) getPathIterator}
 * method of <code>Shape</code>, which flattens the <code>Shape</code>.
 * <li>
 * The current {@link java.awt.Paint} in the <code>Graphics2D</code> context
 ...
 * {@link #drawImage(java.awt.Image, AffineTransform, ImageObserver) drawImage(Image, AffineTransform, ImageObserver)},
 ...
 * <code>clearRect</code>, {@link #fill(java.awt.Shape) fill} can now be called
 ...
 * and <code>drawPolygon</code>, {@link #draw(java.awt.Shape) draw} can now be
...
public abstract class Graphics2D extends java.awt.Graphics {
     ...
     * {@link Graphics#setClip(java.awt.Shape) setClip} with a <code>null</code>
