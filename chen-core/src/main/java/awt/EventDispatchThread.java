...
class EventDispatchThread extends Thread {
    ...
    private ArrayList<java.awt.EventFilter> eventFilters = new ArrayList<java.awt.EventFilter>();

    EventDispatchThread(ThreadGroup group, String name, java.awt.EventQueue queue) {
        super(group, name);
        setEventQueue(queue);
    }
    ...
    boolean filterAndCheckEvent(java.awt.AWTEvent event) {
            ...
            if (modalComponent != null) {
                ...
                if (mouseEvent || actionEvent || windowClosingEvent) {
                    ...
                    if (o instanceof sun.awt.ModalExclude) {
                        ...
                        java.awt.Component c = (Component) o;
