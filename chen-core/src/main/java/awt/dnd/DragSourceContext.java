...
public class DragSourceContext
        ...
        switch (status) {
            ...
            case CHANGED:
                ...
                if (ra == java.awt.dnd.DnDConstants.ACTION_NONE) { // no drop possible
                    ...
                    else if ((ra & java.awt.dnd.DnDConstants.ACTION_MOVE) == java.awt.dnd.DnDConstants.ACTION_MOVE)
        ...
        throws ClassNotFoundException, IOException
    {
        ...
        java.awt.dnd.DragGestureEvent newTrigger = (java.awt.dnd.DragGestureEvent)f.get("trigger", null);
        if (newTrigger == null) {
        ...
        if (newSourceActions == java.awt.dnd.DnDConstants.ACTION_NONE) {
            throw new InvalidObjectException("Invalid source actions");
        }
        int triggerActions = newTrigger.getDragAction();
        if (triggerActions != java.awt.dnd.DnDConstants.ACTION_COPY &&
                triggerActions != java.awt.dnd.DnDConstants.ACTION_MOVE &&
