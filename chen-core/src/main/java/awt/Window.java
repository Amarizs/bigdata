...
public class Window extends Container implements Accessible {
    ...
    private void init(GraphicsConfiguration gc) {
        ...
        setWarningString();
        this.cursor = java.awt.Cursor.getPredefinedCursor(java.awt.Cursor.DEFAULT_CURSOR);
        this.visible = false;
    ...
    public java.util.List<java.awt.Image> getIconImages() {
        java.util.List<java.awt.Image> icons = this.icons;
        if (icons == null || icons.size() == 0) {
            return new ArrayList<java.awt.Image>();
        }
        return new ArrayList<java.awt.Image>(icons);
    }
    ...
    public synchronized void setIconImages(java.util.List<? extends java.awt.Image> icons) {
        this.icons = (icons == null) ? new ArrayList<java.awt.Image>() :
            new ArrayList<java.awt.Image>(icons);
    ...
    public void show() {
        ...
        if (visible) {
            ...
            if (this instanceof java.awt.Frame || this instanceof java.awt.Dialog) {
    ...
    public void setCursor(java.awt.Cursor cursor) {
        if (cursor == null) {
            cursor = java.awt.Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR);
        }
     ...
     *     value is equivalent to {@link java.awt.Dialog.ModalExclusionType#NO_EXCLUDE
     *     NO_EXCLUDE}
 ...
 */
    ...
    */
    ...
    private void deserializeResources(ObjectInputStream s)
        ...
        try {
            ...
            Object obj = s.readObject(); //Throws OptionalDataException
                                         //for pre1.6 objects.
            icons = new ArrayList<java.awt.Image>(); //Frame.readObject() assumes
      ...
      throws ClassNotFoundException, IOException, HeadlessException
    {
         ...
         java.awt.Dialog.ModalExclusionType et = (java.awt.Dialog.ModalExclusionType)
             f.get("modalExclusionType", java.awt.Dialog.ModalExclusionType.NO_EXCLUDE);
     ...
     * <li>The window must be undecorated (see {@link java.awt.Frame#setUndecorated}
     * and {@link java.awt.Dialog#setUndecorated})
     ...
     * alpha component of their color (see {@link Window#setBackground(java.awt.Color)}) and the
     * current shape of this window (see {@link #setShape(java.awt.Shape)}).
     *
     ...
     * @see Window#setBackground(java.awt.Color)
     * @see Window#setShape(java.awt.Shape)
     * @see java.awt.Frame#isUndecorated
     * @see java.awt.Dialog#isUndecorated
     * @see GraphicsDevice.WindowTranslucency
     ...
     * belong to the given {@link java.awt.Shape} remain visible and clickable. If
     ...
     * this window (see {@link #setShape(java.awt.Shape)}).
     * <p>
    ...
    static {
        AWTAccessor.setWindowAccessor(new AWTAccessor.WindowAccessor() {
            ...
            public java.awt.Shape getShape(Window window) {
            ...
            public void setOpaque(Window window, boolean opaque) {
                java.awt.Color bg = window.getBackground();
                if (bg == null) {
                    bg = new java.awt.Color(0, 0, 0, 0);
                }
