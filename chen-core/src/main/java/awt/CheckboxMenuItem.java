 ...
 * @since       JDK1.0
 */
public class CheckboxMenuItem extends MenuItem implements java.awt.ItemSelectable, Accessible {
    ...
    */
    ...
    public void addNotify() {
        synchronized (getTreeLock()) {
            if (peer == null)
                peer = java.awt.Toolkit.getDefaultToolkit().createCheckboxMenuItem(this);
            super.addNotify();
        }
    }
