 ...
 * java.awt.TrayIcon TrayIcons}, which are added to the tray using the {@link
 ...
 * the {@link java.awt.TrayIcon} class for details.
 *
 ...
 * <pre>
 * <code>
 *     {@link java.awt.TrayIcon} trayIcon = null;
 ...
 *         trayIcon = new {@link java.awt.TrayIcon#TrayIcon(java.awt.Image, String, java.awt.PopupMenu) TrayIcon}(image, "Tray Demo", popup);
 *         // set the TrayIcon properties
 *         trayIcon.{@link java.awt.TrayIcon#addActionListener(java.awt.event.ActionListener) addActionListener}(listener);
 *         // ...
 *         // add the tray image
 *         try {
 *             tray.{@link SystemTray#add(java.awt.TrayIcon) add}(trayIcon);
 ...
 *     if (trayIcon != null) {
 *         trayIcon.{@link java.awt.TrayIcon#setImage(java.awt.Image) setImage}(updatedImage);
 *     }
 *     // ...
 * </code>
 * </pre>
...
public class SystemTray {
     ...
     * java.awt.TrayIcon#setPopupMenu(PopupMenu)}) or an action event (see
     * {@link java.awt.TrayIcon#addActionListener(ActionListener)}).
     *
     ...
     * @see #remove(java.awt.TrayIcon)
     * @see #getSystemTray
     * @see java.awt.TrayIcon
     * @see java.awt.Image
     */
    public void add(java.awt.TrayIcon trayIcon) throws AWTException {
        if (trayIcon == null) {
            throw new NullPointerException("adding null TrayIcon");
        }
        java.awt.TrayIcon[] oldArray = null, newArray = null;
        Vector<java.awt.TrayIcon> icons = null;
        synchronized (this) {
            oldArray = systemTray.getTrayIcons();
            icons = (Vector<java.awt.TrayIcon>)AppContext.getAppContext().get(java.awt.TrayIcon.class);
            if (icons == null) {
                icons = new Vector<java.awt.TrayIcon>(3);
                AppContext.getAppContext().put(java.awt.TrayIcon.class, icons);
    ...
    public void remove(java.awt.TrayIcon trayIcon) {
        ...
        synchronized (this) {
            oldArray = systemTray.getTrayIcons();
            Vector<java.awt.TrayIcon> icons = (Vector<java.awt.TrayIcon>)AppContext.getAppContext().get(java.awt.TrayIcon.class);
     ...
     * method {@link java.awt.TrayIcon#getSize} in the <code>TrayIcon</code> class.
     *
    ...
    synchronized void addNotify() {
        if (peer == null) {
            java.awt.Toolkit toolkit = java.awt.Toolkit.getDefaultToolkit();
            if (toolkit instanceof SunToolkit) {
                peer = ((SunToolkit) java.awt.Toolkit.getDefaultToolkit()).createSystemTray(this);
            } else if (toolkit instanceof HeadlessToolkit) {
