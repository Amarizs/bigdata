 ...
 * @see java.awt.Component#getFocusTraversalKeys
 * @since 1.4
 */
public class DefaultKeyboardFocusManager extends java.awt.KeyboardFocusManager {
    ...
    private static final WeakReference<java.awt.Window> NULL_WINDOW_WR =
        new WeakReference<java.awt.Window>(null);
    private static final WeakReference<java.awt.Component> NULL_COMPONENT_WR =
        new WeakReference<java.awt.Component>(null);
    private WeakReference<java.awt.Window> realOppositeWindowWR = NULL_WINDOW_WR;
    private WeakReference<java.awt.Component> realOppositeComponentWR = NULL_COMPONENT_WR;
     ...
     */
    private void restoreFocus(FocusEvent fe, java.awt.Window newFocusedWindow) {
        java.awt.Component realOppositeComponent = this.realOppositeComponentWR.get();
    ...
    private void restoreFocus(WindowEvent we) {
        java.awt.Window realOppositeWindow = this.realOppositeWindowWR.get();
    ...
    private boolean restoreFocus(java.awt.Window aWindow, java.awt.Component vetoedComponent,
                                 boolean clearOnFailure) {
        restoreFocusTo = null;
        java.awt.Component toFocus =
            java.awt.KeyboardFocusManager.getMostRecentFocusOwner(aWindow);
    ...
    private boolean doRestoreFocus(java.awt.Component toFocus, java.awt.Component vetoedComponent,
                                   boolean clearOnFailure)
    {
        ...
        extends java.awt.SentEvent
    {
        ...
        public DefaultKeyboardFocusManagerSentEvent(java.awt.AWTEvent nested,
                                                    AppContext toNotify) {
            ...
            if (ke != null && time >= ke.getWhen()) {
                ...
                if (marker != null) {
                    ...
                    if (toplevel != null && toplevel.isFocused()) {
                        SunToolkit.postEvent(AppContext.getAppContext(), new java.awt.SequencedEvent(e));
                        return true;
                    }
                }
            }
    ...
    public boolean dispatchEvent(java.awt.AWTEvent e) {
        ...
        switch (e.getID()) {
            case WindowEvent.WINDOW_GAINED_FOCUS: {
                ...
                // changed.
                java.awt.Window newActiveWindow =
                ...
                if (inSendMessage == 0) {
                    ...
                    java.awt.Component toFocus = java.awt.KeyboardFocusManager.
            ...
            case FocusEvent.FOCUS_GAINED: {
                ...
                // event in that case.
                final java.awt.Window newFocusedWindow = SunToolkit.getContainingWindow(newFocusOwner);
            ...
            case FocusEvent.FOCUS_LOST: {
                ...
                realOppositeComponentWR = (fe.getOppositeComponent() != null)
                    ? new WeakReference<java.awt.Component>(currentFocusOwner)
                    : NULL_COMPONENT_WR;
            ...
            case WindowEvent.WINDOW_LOST_FOCUS: {
                ...
                realOppositeWindowWR = (oppositeWindow != null)
                    ? new WeakReference<java.awt.Window>(currentFocusedWindow)
                    : NULL_WINDOW_WR;
     ...
     * @see java.awt.Component#dispatchEvent
     */
    ...
    public boolean postProcessKeyEvent(KeyEvent e) {
        if (!e.isConsumed()) {
            ...
            java.awt.Container p = (java.awt.Container)
                (target instanceof java.awt.Container ? target : target.getParent());
            if (p != null) {
     ...
     */
    public void processKeyEvent(java.awt.Component focusedComponent, KeyEvent e) {
            ...
            !e.isConsumed())
        {
            java.awt.AWTKeyStroke stroke = java.awt.AWTKeyStroke.getAWTKeyStrokeForEvent(e),
                oppStroke = java.awt.AWTKeyStroke.getAWTKeyStroke(stroke.getKeyCode(),
                                                 stroke.getModifiers(),
            ...
            if (!((focusedComponent instanceof java.awt.Container) &&
                  ((java.awt.Container)focusedComponent).isFocusCycleRoot())) {
                return;
            }
