...
public abstract class GraphicsDevice {
     ...
     * @see #setFullScreenWindow(java.awt.Window)
     * @since 1.4
     */
     ...
     * with {@link java.awt.DisplayMode#REFRESH_RATE_UNKNOWN} refresh rate will result in
     * selecting a display mode from the list of available display modes with
     * matching width, height and bit depth.
     * However, passing a display mode with {@link java.awt.DisplayMode#BIT_DEPTH_MULTI}
     ...
     * {@link java.awt.DisplayMode#REFRESH_RATE_UNKNOWN} if it is indeterminate.
     * Likewise, the returned display mode is allowed to have a bit depth
     * {@link java.awt.DisplayMode#BIT_DEPTH_MULTI} if it is indeterminate or if multiple
     * bit depths are supported.
     * @return the current display mode of this graphics device.
     * @see #setDisplayMode(java.awt.DisplayMode)
     * @since 1.4
     */
    ...
    boolean isWindowPerpixelTranslucencySupported() {
         ...
         */
        java.awt.Toolkit curToolkit = Toolkit.getDefaultToolkit();
        if (!(curToolkit instanceof SunToolkit)) {
            return false;
        }
