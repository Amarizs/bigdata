...
public class ScrollPane extends Container implements Accessible {
    ...
    private void addToPanel(java.awt.Component comp, Object constraints, int index) {
        java.awt.Panel child = new Panel();
    ...
    public java.awt.Dimension getViewportSize() {
        ...
        return new java.awt.Dimension(width - i.right - i.left,
    ...
    public String paramString() {
        ...
        java.awt.Point p = (getComponentCount()>0)? getScrollPosition() : new Point(0,0);
        Insets i = getInsets();
