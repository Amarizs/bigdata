                                           ...
                                           Serializable
{
    ...
    static {
        AWTAccessor.setComponentAccessor(new AWTAccessor.ComponentAccessor() {
            ...
            public java.awt.Point getLocation(Component comp) {
            ...
            public java.awt.Cursor getCursor(Component comp) {
            ...
            public java.awt.Color getForeground(Component comp) {
                return comp.foreground;
            }
            public java.awt.Color getBackground(Component comp) {
                return comp.background;
            }
            public void setBackground(Component comp, java.awt.Color background) {
                comp.background = background;
            }
            public java.awt.Font getFont(Component comp) {
                return comp.getFont_NoClientCode();
            }
            public void processEvent(Component comp, java.awt.AWTEvent e) {
                comp.processEvent(e);
            }
    ...
    java.awt.Point pointRelativeToComponent(java.awt.Point absolute) {
        ...
        return new java.awt.Point(absolute.x - compCoords.x,
        ...
        if (!visible) {
            synchronized (getTreeLock()) {
                ...
                if (componentListener != null ||
                    (eventMask & java.awt.AWTEvent.COMPONENT_EVENT_MASK) != 0 ||
                    java.awt.Toolkit.enabledOnToolkit(java.awt.AWTEvent.COMPONENT_EVENT_MASK)) {
    ...
    public java.awt.Color getForeground() {
        java.awt.Color foreground = this.foreground;
        if (foreground != null) {
            return foreground;
        }
        Container parent = this.parent;
    ...
    public java.awt.Color getBackground() {
        java.awt.Color background = this.background;
        if (background != null) {
            return background;
        }
        Container parent = this.parent;
            ...
            try {
                ...
                if (peer != null) {
                    ...
                    if (!(peer instanceof LightweightPeer)) {
                        ...
                        if (this instanceof java.awt.Window) {
                            needNotify = false;
                        }
                    }
                    if (resized) {
     ...
     * {@link java.awt.Graphics#getFontMetrics()} or text measurement APIs on the
     * {@link java.awt.Font Font} class.
     * @param font the font for which font metrics is to be
     *          obtained
     * @return the font metrics for <code>font</code>
     * @see       #getFont
     * @see       #getPeer
     * @see       ComponentPeer#getFontMetrics(java.awt.Font)
    ...
    final java.awt.Cursor getCursor_NoClientCode() {
        java.awt.Cursor cursor = this.cursor;
        if (cursor != null) {
            return cursor;
        }
        Container parent = this.parent;
    ...
    private java.awt.Insets getInsets_NoClientCode() {
        ...
        if (peer instanceof ContainerPeer) {
            return (java.awt.Insets)((ContainerPeer)peer).getInsets().clone();
        }
     ...
     *
     * @see     ImageObserver
     * @see     java.awt.Graphics#drawImage(java.awt.Image, int, int, java.awt.Color, ImageObserver)
     * @see     java.awt.Graphics#drawImage(java.awt.Image, int, int, ImageObserver)
     * @see     java.awt.Graphics#drawImage(java.awt.Image, int, int, int, int, java.awt.Color, ImageObserver)
     * @see     java.awt.Graphics#drawImage(java.awt.Image, int, int, int, int, ImageObserver)
     ...
     * @since     JDK1.0
     */
    public boolean prepareImage(java.awt.Image image, ImageObserver observer) {
     ...
     * @since     JDK1.0
     */
    public boolean prepareImage(java.awt.Image image, int width, int height,
     ...
     * @see      #prepareImage(java.awt.Image, int, int, ImageObserver)
     * @see      java.awt.Toolkit#checkImage(java.awt.Image, int, int, ImageObserver)
     * @see      ImageObserver
     * @since    JDK1.0
     */
    public int checkImage(java.awt.Image image, ImageObserver observer) {
     ...
     * @since    JDK1.0
     */
    public int checkImage(java.awt.Image image, int width, int height,
                          ImageObserver observer) {
        ComponentPeer peer = this.peer;
        if (peer instanceof LightweightPeer) {
            return (parent != null)
    ...
    protected class FlipBufferStrategy extends BufferStrategy {
         ...
         * The drawing buffer
         */
        protected java.awt.Image drawBuffer; // = null
        /**
        ...
        protected FlipBufferStrategy(int numBuffers, BufferCapabilities caps)
            throws AWTException
        {
            if (!(Component.this instanceof java.awt.Window) &&
                !(Component.this instanceof java.awt.Canvas))
            {
     ...
     * @see       #getComponentAt(java.awt.Point)
     * @since     JDK1.1
     */
    ...
    boolean checkWindowClosingException() {
        if (windowClosingException != null) {
            if (this instanceof java.awt.Dialog) {
    ...
    boolean areInputMethodsEnabled() {
        ...
        return ((eventMask & java.awt.AWTEvent.INPUT_METHODS_ENABLED_MASK) != 0) &&
            ((eventMask & java.awt.AWTEvent.KEY_EVENT_MASK) != 0 || keyListener != null);
    }
    ...
    boolean eventTypeEnabled(int type) {
        switch(type) {
          ...
          case ComponentEvent.COMPONENT_HIDDEN:
              if ((eventMask & java.awt.AWTEvent.COMPONENT_EVENT_MASK) != 0 ||
          ...
          case FocusEvent.FOCUS_LOST:
              if ((eventMask & java.awt.AWTEvent.FOCUS_EVENT_MASK) != 0 ||
                  focusListener != null) {
                  return true;
              }
              break;
          ...
          case KeyEvent.KEY_TYPED:
              if ((eventMask & java.awt.AWTEvent.KEY_EVENT_MASK) != 0 ||
                  keyListener != null) {
                  return true;
              }
              break;
          ...
          case MouseEvent.MOUSE_CLICKED:
              if ((eventMask & java.awt.AWTEvent.MOUSE_EVENT_MASK) != 0 ||
                  mouseListener != null) {
                  return true;
              }
              break;
          ...
          case MouseEvent.MOUSE_DRAGGED:
              if ((eventMask & java.awt.AWTEvent.MOUSE_MOTION_EVENT_MASK) != 0 ||
                  mouseMotionListener != null) {
                  return true;
              }
              break;
          case MouseEvent.MOUSE_WHEEL:
              if ((eventMask & java.awt.AWTEvent.MOUSE_WHEEL_EVENT_MASK) != 0 ||
          ...
          case InputMethodEvent.CARET_POSITION_CHANGED:
              if ((eventMask & java.awt.AWTEvent.INPUT_METHOD_EVENT_MASK) != 0 ||
                  inputMethodListener != null) {
                  return true;
              }
              break;
          case HierarchyEvent.HIERARCHY_CHANGED:
              if ((eventMask & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) != 0 ||
          ...
          case HierarchyEvent.ANCESTOR_RESIZED:
              if ((eventMask & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) != 0 ||
    ...
    public void addHierarchyListener(HierarchyListener l) {
        ...
        synchronized (this) {
            notifyAncestors =
                (hierarchyListener == null &&
                 (eventMask & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) == 0);
        ...
        if (notifyAncestors) {
            synchronized (getTreeLock()) {
                adjustListeningChildrenOnParent(java.awt.AWTEvent.HIERARCHY_EVENT_MASK,
                                                1);
            }
        }
    }
    ...
    public void addHierarchyBoundsListener(HierarchyBoundsListener l) {
        ...
        synchronized (this) {
            notifyAncestors =
                (hierarchyBoundsListener == null &&
                 (eventMask & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) == 0);
        ...
        if (notifyAncestors) {
            synchronized (getTreeLock()) {
                adjustListeningChildrenOnParent(
                                                java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK, 1);
            }
        }
    }
    ...
    protected final void enableEvents(long eventsToEnable) {
        ...
        synchronized (this) {
            if ((eventsToEnable & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) != 0 &&
                hierarchyListener == null &&
                (eventMask & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) == 0) {
                notifyAncestors |= java.awt.AWTEvent.HIERARCHY_EVENT_MASK;
            }
            if ((eventsToEnable & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) != 0 &&
                hierarchyBoundsListener == null &&
                (eventMask & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) == 0) {
    ...
    protected final void disableEvents(long eventsToDisable) {
        long notifyAncestors = 0;
        synchronized (this) {
            if ((eventsToDisable & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) != 0 &&
                hierarchyListener == null &&
                (eventMask & java.awt.AWTEvent.HIERARCHY_EVENT_MASK) != 0) {
                notifyAncestors |= java.awt.AWTEvent.HIERARCHY_EVENT_MASK;
            }
            if ((eventsToDisable & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK)!=0 &&
                hierarchyBoundsListener == null &&
                (eventMask & java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) != 0) {
                notifyAncestors |= java.awt.AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK;
            }
    ...
    private static final Class[] coalesceEventsParams = {
        java.awt.AWTEvent.class, java.awt.AWTEvent.class
    };
            ...
            if (peer == null || peer instanceof LightweightPeer){
                ...
                if (parent != null) {
                    ...
                    if ((mouseMotionListener != null) ||
                        ((eventMask & java.awt.AWTEvent.MOUSE_MOTION_EVENT_MASK) != 0)) {
                        mask |= java.awt.AWTEvent.MOUSE_MOTION_EVENT_MASK;
                    }
                    if ((mouseWheelListener != null ) ||
                        ((eventMask & java.awt.AWTEvent.MOUSE_WHEEL_EVENT_MASK) != 0)) {
    ...
    java.awt.Point getLocationOnWindow() {
        ...
        for (Container parent = getContainer();
                parent != null && !(parent instanceof java.awt.Window);
