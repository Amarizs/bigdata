 ...
 */
class SequencedEvent extends java.awt.AWTEvent implements ActiveEvent {
    /*
     * serialVersionUID
     */
    ...
    final void dispose() {
      synchronized (SequencedEvent.class) {
        ...
        // Wake myself up
        if (appContext != null) {
            SunToolkit.postEvent(appContext, new java.awt.SentEvent());
        }
        ...
        if (next != null && next.appContext != null) {
            SunToolkit.postEvent(next.appContext, new java.awt.SentEvent());
        }
    }
}
