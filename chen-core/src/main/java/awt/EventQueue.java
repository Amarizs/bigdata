 ...
 * {@link #dispatchEvent(java.awt.AWTEvent) dispatchEvent(AWTEvent)} method
...
public class EventQueue {
     ...
     */
    private WeakReference<java.awt.AWTEvent> currentEvent;
    ...
    private boolean coalescePaintEvent(PaintEvent e) {
        ComponentPeer sourcePeer = ((java.awt.Component)e.getSource()).peer;
        if (sourcePeer != null) {
            sourcePeer.coalescePaintEvent(e);
        }
        EventQueueItem[] cache = ((java.awt.Component)e.getSource()).eventCache;
        if (cache == null) {
            return false;
        }
    ...
    private boolean coalesceOtherEvent(java.awt.AWTEvent e, int priority) {
            ...
            entry != null; entry = entry.next)
        {
            ...
            if (entry.event.getSource() == source && entry.event.getID() == id) {
                java.awt.AWTEvent coalescedEvent = source.coalesceEvents(
                    entry.event, e);
    ...
    private boolean coalesceEvent(java.awt.AWTEvent e, int priority) {
        ...
        // The worst case
        if (((java.awt.Component)e.getSource()).isCoalescingEnabled()
     ...
     */
    java.awt.AWTEvent getNextEventPrivate() throws InterruptedException {
    ...
    java.awt.AWTEvent getNextEvent(int id) throws InterruptedException {
        do {
            /*
             * SunToolkit.flushPendingEvents must be called outside
             * of the synchronized block to avoid deadlock when
    ...
    private static AccessControlContext getAccessControlContextFrom(Object src) {
        return src instanceof java.awt.Component ?
            ((java.awt.Component)src).getAccessControlContext() :
            src instanceof MenuComponent ?
                ((MenuComponent)src).getAccessControlContext() :
                src instanceof java.awt.TrayIcon ?
                    ((java.awt.TrayIcon)src).getAccessControlContext() :
                    null;
    }
     ...
     */
    private void dispatchEventImpl(final java.awt.AWTEvent event, final Object src) {
        event.isPosted = true;
     ...
     * {@link java.awt.Toolkit#getSystemEventQueue the current AWT EventQueue}'s
    ...
    public static boolean isDispatchThread() {
        EventQueue eq = java.awt.Toolkit.getEventQueue();
                    ...
                    if ((entry.event.getSource() == source)
                        && (removeAllEvents
                            || ! (entry.event instanceof SequencedEvent
                                  || entry.event instanceof java.awt.SentEvent
     ...
     * {@link java.awt.Toolkit#getSystemEventQueue the system EventQueue}.
     ...
     *                  of {@link java.awt.Toolkit#getSystemEventQueue the system EventQueue}
     * @see             #invokeAndWait
     * @see             java.awt.Toolkit#getSystemEventQueue
     * @see             #isDispatchThread
     * @since           1.2
    ...
    public static void invokeLater(Runnable runnable) {
        java.awt.Toolkit.getEventQueue().postEvent(
            new InvocationEvent(java.awt.Toolkit.getDefaultToolkit(), runnable));
    }
    ...
    public static void invokeAndWait(Runnable runnable)
        throws InterruptedException, InvocationTargetException
    {
        invokeAndWait(java.awt.Toolkit.getDefaultToolkit(), runnable);
    }
