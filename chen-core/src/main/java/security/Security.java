...
public final class Security {
    ...
    private static ProviderProperty getProviderProperty(String key) {
        ...
        for (int i = 0; i < providers.size(); i++) {
            ...
            java.security.Provider prov = providers.get(i);
     ...
     */
    private static String getProviderProperty(String key, java.security.Provider provider) {
     ...
     */
    public static synchronized int insertProviderAt(java.security.Provider provider,
                                                    int position) {
     ...
     * @since 1.3
     */
    public static java.security.Provider[] getProviders(Map<String,String> filter) {
        // Get all installed providers first.
        // Then only return those providers who satisfy the selection criteria.
        java.security.Provider[] allProviders = Security.getProviders();
        Set<String> keySet = filter.keySet();
        LinkedHashSet<java.security.Provider> candidates = new LinkedHashSet<>(5);
        ...
        for (Iterator<String> ite = keySet.iterator(); ite.hasNext(); ) {
            ...
            LinkedHashSet<java.security.Provider> newCandidates = getAllQualifyingCandidates(key, value,
                                                               allProviders);
            if (firstSearch) {
            ...
            if ((newCandidates != null) && !newCandidates.isEmpty()) {
                ...
                for (Iterator<java.security.Provider> cansIte = candidates.iterator();
                     cansIte.hasNext(); ) {
                    java.security.Provider prov = cansIte.next();
        ...
        java.security.Provider[] result = new java.security.Provider[candidatesArray.length];

        for (int i = 0; i < result.length; i++) {
            result[i] = (java.security.Provider)candidatesArray[i];
        }
     ...
     */
    static Object[] getImpl(String algorithm, String type, java.security.Provider provider)
    ...
    * criterion.
    */
    private static LinkedHashSet<java.security.Provider> getAllQualifyingCandidates(
                                                String filterKey,
                                                String filterValue,
                                                java.security.Provider[] allProviders) {
    ...
    private static LinkedHashSet<java.security.Provider> getProvidersNotUsingCache(
                                                String serviceName,
                                                String algName,
                                                String attrName,
                                                String filterValue,
     ...
     */
    private static boolean isCriterionSatisfied(java.security.Provider prov,
                                                String serviceName,
                                                String algName,
                                                String attrName,
                                                String filterValue) {
