...
public class KeyStore {
    ...
    public static final class PrivateKeyEntry implements Entry {
        ...
        private final Set<java.security.KeyStore.Entry.Attribute> attributes;
        ...
        public PrivateKeyEntry(PrivateKey privateKey, Certificate[] chain) {
            this(privateKey, chain, Collections.<java.security.KeyStore.Entry.Attribute>emptySet());
        }
         ...
         */
        public PrivateKeyEntry(PrivateKey privateKey, Certificate[] chain,
           Set<java.security.KeyStore.Entry.Attribute> attributes) {
         ...
         */
        @Override
        public Set<java.security.KeyStore.Entry.Attribute> getAttributes() {
            return attributes;
        }
    ...
    public static final class SecretKeyEntry implements Entry {
        ...
        public SecretKeyEntry(SecretKey secretKey) {
            ...
            this.sKey = secretKey;
            this.attributes = Collections.<java.security.KeyStore.Entry.Attribute>emptySet();
        }
         ...
         * @since 1.8
         */
        public SecretKeyEntry(SecretKey secretKey, Set<java.security.KeyStore.Entry.Attribute> attributes) {
     ...
     */
    public final java.security.Key getKey(String alias, char[] password)
