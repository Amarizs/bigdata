...
public final class AccessControlContext {
    ...
    private java.security.DomainCombiner combiner = null;
    ...
    public AccessControlContext(java.security.ProtectionDomain context[])
    {
        if (context.length == 0) {
            ...
            List<java.security.ProtectionDomain> v = new ArrayList<>(context.length);
            for (int i =0; i< context.length; i++) {
                if ((context[i] != null) &&  (!v.contains(context[i])))
                    v.add(context[i]);
            }
            if (!v.isEmpty()) {
                this.context = new java.security.ProtectionDomain[v.size()];
     ...
     */
    AccessControlContext(java.security.ProtectionDomain caller, java.security.DomainCombiner combiner,
                         ...
                         java.security.Permission[] perms)
    {
         ...
         */
        java.security.ProtectionDomain[] callerPDs = null;
        if (caller != null) {
             callerPDs = new java.security.ProtectionDomain[] { caller };
        }
        if (context != null) {
            if (combiner != null) {
        ...
        java.security.Permission[] tmp = null;
        if (perms != null) {
            tmp = new java.security.Permission[perms.length];
    ...
    AccessControlContext(java.security.ProtectionDomain context[],
    ...
    java.security.DomainCombiner getAssignedCombiner() {
        ...
        if (isPrivileged) {
            ...
            acc = java.security.AccessController.getInheritedAccessControlContext();
        }
        if (acc != null) {
            return acc.combiner;
        }
        ...
        for (int i=0; i< context.length; i++) {
            if (context[i] != null &&  !context[i].implies(perm)) {
                ...
                if (Debug.isOn("failure") && debug != null) {
                    ...
                    Thread.dumpStack();
                    final java.security.ProtectionDomain pd = context[i];
     ...
     */
    private void checkPermission2(java.security.Permission perm) {
        if (!isLimited) {
            return;
        }
        ...
        if (permissions != null) {
            ...
            for (int i=0; i < permissions.length; i++) {
                java.security.Permission limit = permissions[i];
    ...
    AccessControlContext optimize() {
        ...
        java.security.Permission[] permissions = null;
        ...
        java.security.ProtectionDomain[] assigned = (skipAssigned) ? null : acc.context;
     ...
     */
    private static java.security.ProtectionDomain[] combine(java.security.ProtectionDomain[]current,
        ...
        java.security.ProtectionDomain pd[] = new java.security.ProtectionDomain[slen + n];
    ...
    outer:
        for (int i = 0; i < slen; i++) {
            java.security.ProtectionDomain sd = current[i];
            if (sd != null) {
                for (int j = 0; j < n; j++) {
                    if (sd == pd[j]) {
                        continue outer;
        ...
        if (n != pd.length) {
            ...
            java.security.ProtectionDomain tmp[] = new java.security.ProtectionDomain[n];
    ...
    private void calculateFields(AccessControlContext assigned,
        AccessControlContext parent, java.security.Permission[] permissions)
    {
        java.security.ProtectionDomain[] parentLimit = null;
        java.security.ProtectionDomain[] assignedLimit = null;
        java.security.ProtectionDomain[] newLimit;
    ...
    private boolean equalPDs(java.security.ProtectionDomain[] a, java.security.ProtectionDomain[] b) {
        if (a == null) {
            return (b == null);
        }
    ...
    private static boolean containsAllPDs(java.security.ProtectionDomain[] thisContext,
                                          java.security.ProtectionDomain[] thatContext) {
        boolean match = false;
        ...
        java.security.ProtectionDomain thisPd;
    ...
    private boolean containsAllLimits(AccessControlContext that) {
        boolean match = false;
        java.security.Permission thisPerm;

        if (this.permissions == null && that.permissions == null)
            return true;

        for (int i = 0; i < this.permissions.length; i++) {
            java.security.Permission limit = this.permissions[i];
