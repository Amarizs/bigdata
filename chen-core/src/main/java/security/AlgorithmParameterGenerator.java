...
public class AlgorithmParameterGenerator {
    ...
    (AlgorithmParameterGeneratorSpi paramGenSpi, java.security.Provider provider,
     String algorithm) {
    ...
    public static AlgorithmParameterGenerator getInstance(String algorithm)
        throws java.security.NoSuchAlgorithmException {
            try {
                Object[] objs = java.security.Security.getImpl(algorithm,
                                                 "AlgorithmParameterGenerator",
                                                 (String)null);
                return new AlgorithmParameterGenerator
                    ((AlgorithmParameterGeneratorSpi)objs[0],
                     (java.security.Provider)objs[1],
                     algorithm);
            } catch(java.security.NoSuchProviderException e) {
                throw new java.security.NoSuchAlgorithmException(algorithm + " not found");
            }
    }
        ...
        throws java.security.NoSuchAlgorithmException, NoSuchProviderException
    {
        ...
        Object[] objs = java.security.Security.getImpl(algorithm,
                                         ...
                                         provider);
        return new AlgorithmParameterGenerator
            ((AlgorithmParameterGeneratorSpi)objs[0], (java.security.Provider)objs[1],
             algorithm);
    }
    ...
    public final void init(int size) {
        paramGenSpi.engineInit(size, new java.security.SecureRandom());
    }
    ...
    public final void init(AlgorithmParameterSpec genParamSpec)
        throws InvalidAlgorithmParameterException {
            paramGenSpi.engineInit(genParamSpec, new java.security.SecureRandom());
    }
