    ...
    implements java.io.Serializable
{
    ...
    /**
      ...
      */
    private transient Map<String, java.security.Permission> perms;
    ...
    public BasicPermissionCollection(Class<?> clazz) {
        perms = new HashMap<String, java.security.Permission>(11);
        all_allowed = false;
        permClass = clazz;
    }
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        Hashtable<String, java.security.Permission> permissions =
         ...
         throws IOException, ClassNotFoundException
    {
        ...
        Hashtable<String, java.security.Permission> permissions =
                (Hashtable<String, java.security.Permission>)gfields.get("permissions", null);
        perms = new HashMap<String, java.security.Permission>(permissions.size()*2);
        ...
        if (permClass == null) {
            // set permClass
            Enumeration<java.security.Permission> e = permissions.elements();
