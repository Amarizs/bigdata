...
public abstract class KeyStoreSpi {
     ...
     */
    public abstract java.security.Key engineGetKey(String alias, char[] password)
     ...
     */
    public abstract void engineSetKeyEntry(String alias, java.security.Key key,
                                           char[] password,
                                           Certificate[] chain)
    ...
    public void engineLoad(LoadStoreParameter param)
        ...
        if (param instanceof java.security.KeyStore.SimpleLoadStoreParameter) {
