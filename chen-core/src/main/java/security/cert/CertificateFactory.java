...
public class CertificateFactory {
     ...
     */
    public final java.security.cert.Certificate generateCertificate(InputStream inStream)
        throws CertificateException
    {
     ...
     * @since 1.4
     */
    public final java.security.cert.CertPath generateCertPath(InputStream inStream)
        throws CertificateException
    {
    ...
    public final CertPath
        generateCertPath(List<? extends java.security.cert.Certificate> certificates)
        throws CertificateException
    {
     ...
     */
    public final java.security.cert.CRL generateCRL(InputStream inStream)
