...
public abstract class CertificateFactorySpi {
     ...
     */
    public abstract java.security.cert.Certificate engineGenerateCertificate(InputStream inStream)
     ...
     * @since 1.4
     */
    public java.security.cert.CertPath engineGenerateCertPath(InputStream inStream)
        throws java.security.cert.CertificateException
    {
     ...
     */
    public java.security.cert.CertPath engineGenerateCertPath(InputStream inStream,
                                                              String encoding) throws java.security.cert.CertificateException
    {
        throw new UnsupportedOperationException();
    }
     ...
     */
    public CertPath
        engineGenerateCertPath(List<? extends java.security.cert.Certificate> certificates)
        throws java.security.cert.CertificateException
    {
        throw new UnsupportedOperationException();
    }
     ...
     */
    public abstract java.security.cert.CRL engineGenerateCRL(InputStream inStream)
