...
public class CertificateRevokedException extends CertificateException {
    ...
    private transient Map<String, java.security.cert.Extension> extensions;
     ...
     */
    public CertificateRevokedException(Date revocationDate, java.security.cert.CRLReason reason,
        X500Principal authority, Map<String, java.security.cert.Extension> extensions) {
        ...
        this.extensions = Collections.checkedMap(new HashMap<>(),
                                                 String.class, java.security.cert.Extension.class);
    ...
    public Date getInvalidityDate() {
        java.security.cert.Extension ext = getExtensions().get("2.5.29.24");
        if (ext == null) {
            return null;
        } else {
            try {
    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
        ...
        for (Map.Entry<String, java.security.cert.Extension> entry : extensions.entrySet()) {
            java.security.cert.Extension ext = entry.getValue();
