...
public class KeyFactory {
     ...
     */
    protected KeyFactory(KeyFactorySpi keyFacSpi, java.security.Provider provider,
                         String algorithm) {
        this.spi = keyFacSpi;
     ...
     * @since 1.4
     */
    public static KeyFactory getInstance(String algorithm, java.security.Provider provider)
            throws NoSuchAlgorithmException {
        Instance instance = GetInstance.getInstance("KeyFactory",
            KeyFactorySpi.class, algorithm, provider);
        return new KeyFactory((KeyFactorySpi)instance.impl,
     ...
     */
    public final <T extends KeySpec> T getKeySpec(java.security.Key key, Class<T> keySpec)
            throws InvalidKeySpecException {
        if (serviceIterator == null) {
     ...
     * by this key factory.
     */
    public final java.security.Key translateKey(Key key) throws InvalidKeyException {
        if (serviceIterator == null) {
