 ...
 *
 * <p> The {@link #checkPermission(java.security.Permission) checkPermission} method
...
public final class AccessController {
    ...
    public static <T> T doPrivilegedWithCombiner(PrivilegedAction<T> action) {
        ...
        java.security.DomainCombiner dc = acc.getAssignedCombiner();
        return AccessController.doPrivileged(action,
    ...
    public static <T> T doPrivileged(PrivilegedAction<T> action,
        AccessControlContext context, java.security.Permission... perms) {
    ...
    public static <T> T doPrivilegedWithCombiner(PrivilegedAction<T> action,
        ...
        AccessControlContext parent = getContext();
        java.security.DomainCombiner dc = parent.getCombiner();
     ...
     */
    private static AccessControlContext preserveCombiner(java.security.DomainCombiner combiner,
                                                         Class<?> caller)
    {
    ...
    private static AccessControlContext
        createWrapper(java.security.DomainCombiner combiner, Class<?> caller,
