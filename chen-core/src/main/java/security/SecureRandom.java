...
public class SecureRandom extends Random {
     ...
     * @since 1.2
     */
    private java.security.Provider provider = null;
    ...
    private SecureRandom(SecureRandomSpi secureRandomSpi, java.security.Provider provider,
            String algorithm) {
        super(0);
     ...
     */
    public static SecureRandom getInstance(String algorithm,
            java.security.Provider provider) throws NoSuchAlgorithmException {
        Instance instance = GetInstance.getInstance("SecureRandom",
            SecureRandomSpi.class, algorithm, provider);
        return new SecureRandom((SecureRandomSpi)instance.impl,
            instance.provider, algorithm);
     ...
     * securerandom.strongAlgorithms} {@link java.security.Security} property.
     * <p>
