...
public abstract class MessageDigest extends MessageDigestSpi {
    ...
    throws NoSuchAlgorithmException {
        try {
            MessageDigest md;
            Object[] objs = java.security.Security.getImpl(algorithm, "MessageDigest",
                                             (String)null);
            ...
            md.provider = (java.security.Provider)objs[1];
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException
    {
        ...
        Object[] objs = java.security.Security.getImpl(algorithm, "MessageDigest", provider);
        if (objs[0] instanceof MessageDigest) {
            ...
            delegate.provider = (java.security.Provider)objs[1];
            return delegate;
        }
    }
