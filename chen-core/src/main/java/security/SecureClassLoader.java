...
public class SecureClassLoader extends ClassLoader {
    ...
    // @GuardedBy("pdcache")
    private final HashMap<java.security.CodeSource, java.security.ProtectionDomain> pdcache =
                        new HashMap<>(11);
     ...
     */
    private java.security.ProtectionDomain getProtectionDomain(CodeSource cs) {
        if (cs == null)
            return null;

        java.security.ProtectionDomain pd = null;
