...
public class EllipticCurve {
    ...
    private static void checkValidity(java.security.spec.ECField field, BigInteger c,
                                      String cName) {
        ...
        } else if (field instanceof java.security.spec.ECFieldF2m) {
     ...
     */
    public EllipticCurve(java.security.spec.ECField field, BigInteger a,
                         BigInteger b) {
        this(field, a, b, null);
    }
