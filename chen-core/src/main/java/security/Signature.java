...
public abstract class Signature extends SignatureSpi {
    ...
    public static Signature getInstance(String algorithm, String provider)
        ...
        if (algorithm.equalsIgnoreCase(RSA_SIGNATURE)) {
            ...
            java.security.Provider p = Security.getProvider(provider);
            if (p == null) {
     ...
     * @since 1.4
     */
    public static Signature getInstance(String algorithm, java.security.Provider provider)
            throws NoSuchAlgorithmException {
        if (algorithm.equalsIgnoreCase(RSA_SIGNATURE)) {
            // exception compatibility with existing code
            if (provider == null) {
    ...
    private static Signature getInstanceRSA(java.security.Provider p)
            throws NoSuchAlgorithmException {
        // try Signature first
    ...
    private static class Delegate extends Signature {
        ...
        public Object clone() throws CloneNotSupportedException {
            ...
            if (sigSpi instanceof Cloneable) {
                ...
                // access them.
                Signature that =
                    new java.security.Signature.Delegate(sigSpiClone, ((Signature)this).algorithm);
        ...
        private static SignatureSpi newInstance(Service s)
            ...
            if (s.getType().equals("Cipher")) {
                ...
                try {
                    ...
                    return new java.security.Signature.CipherAdapter(c);
        ...
        private void chooseProvider(int type, java.security.Key key, SecureRandom random)
                throws InvalidKeyException {
            synchronized (lock) {
                if (sigSpi != null) {
        ...
        private void init(SignatureSpi spi, int type, Key key,
            ...
            switch (type) {
            case I_PUB:
                spi.engineInitVerify((java.security.PublicKey)key);
                break;
            case I_PRIV:
