...
public final class FileSystems {
    ...
    private static class DefaultFileSystemHolder {
        static final java.nio.file.FileSystem defaultFileSystem = defaultFileSystem();
     ...
     *          permission
     */
    public static java.nio.file.FileSystem getFileSystem(URI uri) {
     ...
     */
    public static java.nio.file.FileSystem newFileSystem(URI uri, Map<String,?> env)
        throws IOException
    {
     ...
     *          permission required by the file system provider implementation
     */
    public static java.nio.file.FileSystem newFileSystem(URI uri, Map<String,?> env, ClassLoader loader)
        throws IOException
    {
        String scheme = uri.getScheme();
     ...
     * FileSystemProvider#newFileSystem(java.nio.file.Path,Map) newFileSystem(Path,Map)} method
