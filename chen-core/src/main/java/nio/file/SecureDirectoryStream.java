 ...
 * then the {@code DirectoryStream} returned by the {@link java.nio.file.Files#newDirectoryStream
    ...
    extends DirectoryStream<T>
{
     ...
     * java.nio.file.Files#newDirectoryStream(java.nio.file.Path) newDirectoryStream} method for the case that
     ...
     * java.nio.file.LinkOption#NOFOLLOW_LINKS NOFOLLOW_LINKS} option may be used to
     ...
     */
    SecureDirectoryStream<T> newDirectoryStream(T path, java.nio.file.LinkOption... options)
        throws IOException;
     ...
     *
     * <p> This method works in exactly the manner specified by the {@link
     * java.nio.file.Files#newByteChannel Files.newByteChannel} method for the
