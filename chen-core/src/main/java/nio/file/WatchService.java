 ...
 *
 * <p> A {@link java.nio.file.Watchable} object is registered with a watch service by invoking
 * its {@link Watchable#register register} method, returning a {@link java.nio.file.WatchKey}
 ...
 * discards events then it arranges for the key's {@link java.nio.file.WatchKey#pollEvents
    ...
    extends Closeable
{
     ...
     */
    java.nio.file.WatchKey poll(long timeout, TimeUnit unit)
        throws InterruptedException;
