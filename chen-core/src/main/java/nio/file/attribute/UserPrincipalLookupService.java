...
/**
 * An object to lookup user and group principals by name. A {@link java.nio.file.attribute.UserPrincipal}
 * represents an identity that may be used to determine access rights to objects
 * in a file system. A {@link java.nio.file.attribute.GroupPrincipal} represents a <em>group identity</em>.
