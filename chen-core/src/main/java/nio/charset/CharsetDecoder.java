...
public abstract class CharsetDecoder {
     ...
     */
    private
    CharsetDecoder(java.nio.charset.Charset cs,
     ...
     *          If the preconditions on the parameters do not hold
     */
    protected CharsetDecoder(java.nio.charset.Charset cs,
                             float averageCharsPerByte,
                             float maxCharsPerByte)
    {
        this(cs,
     ...
     */
    public final java.nio.charset.CoderResult decode(ByteBuffer in, CharBuffer out,
                                                     boolean endOfInput)
    {
     ...
     *          parameter
     */
    public final java.nio.charset.CoderResult flush(CharBuffer out) {
        if (state == ST_END) {
     ...
     * @return  A coder-result object describing the reason for termination
     */
    protected abstract java.nio.charset.CoderResult decodeLoop(ByteBuffer in,
                                                               CharBuffer out);
