    ...
    implements DirectBuffer
{
    ...
    public java.nio.FloatBuffer get(float[] dst, int offset, int length) {
        ...
        if (((long)length << 2) > java.nio.Bits.JNI_COPY_TO_ARRAY_THRESHOLD) {
    ...
    public java.nio.FloatBuffer put(float[] src, int offset, int length) {
        ...
        if (((long)length << 2) > java.nio.Bits.JNI_COPY_FROM_ARRAY_THRESHOLD) {
            ...
            if (order() != java.nio.ByteOrder.nativeOrder())
                java.nio.Bits.copyFromIntArray(src,
                                            (long)offset << 2,
                                            ix(pos),
                                            (long)length << 2);
            else
