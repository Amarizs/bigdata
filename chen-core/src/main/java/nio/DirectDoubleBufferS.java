    ...
    implements DirectBuffer
{
    ...
    public java.nio.DoubleBuffer get(double[] dst, int offset, int length) {
        ...
        if (((long)length << 3) > java.nio.Bits.JNI_COPY_TO_ARRAY_THRESHOLD) {
    ...
    public java.nio.DoubleBuffer put(double[] src, int offset, int length) {
        ...
        if (((long)length << 3) > java.nio.Bits.JNI_COPY_FROM_ARRAY_THRESHOLD) {
            ...
            if (order() != java.nio.ByteOrder.nativeOrder())
                java.nio.Bits.copyFromLongArray(src,
                                            (long)offset << 3,
                                            ix(pos),
                                            (long)length << 3);
            else
