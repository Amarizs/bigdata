    ...
    implements DirectBuffer
{
    ...
    public java.nio.ByteBuffer get(byte[] dst, int offset, int length) {
        ...
        if (((long)length << 0) > java.nio.Bits.JNI_COPY_TO_ARRAY_THRESHOLD) {
    ...
    public java.nio.ByteBuffer put(byte[] src, int offset, int length) {
        ...
        if (((long)length << 0) > java.nio.Bits.JNI_COPY_FROM_ARRAY_THRESHOLD) {
        ...
        if (!unaligned && ((address + off) % (1 << 1) != 0)) {
            return (bigEndian
                    ? (java.nio.CharBuffer)(new ByteBufferAsCharBufferB(this,
                                                                       ...
                                                                       size,
                                                                       off))
                    : (java.nio.CharBuffer)(new ByteBufferAsCharBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? (java.nio.CharBuffer)(new DirectCharBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
        ...
        if (!unaligned && ((address + off) % (1 << 1) != 0)) {
            return (bigEndian
                    ? (java.nio.ShortBuffer)(new ByteBufferAsShortBufferB(this,
                                                                       ...
                                                                       size,
                                                                       off))
                    : (java.nio.ShortBuffer)(new ByteBufferAsShortBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? (java.nio.ShortBuffer)(new DirectShortBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
        ...
        if (!unaligned && ((address + off) % (1 << 2) != 0)) {
            return (bigEndian
                    ? (java.nio.IntBuffer)(new ByteBufferAsIntBufferB(this,
                                                                       ...
                                                                       size,
                                                                       off))
                    : (java.nio.IntBuffer)(new ByteBufferAsIntBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? (java.nio.IntBuffer)(new DirectIntBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
        ...
        if (!unaligned && ((address + off) % (1 << 3) != 0)) {
            return (bigEndian
                    ? (java.nio.LongBuffer)(new ByteBufferAsLongBufferB(this,
                                                                       ...
                                                                       size,
                                                                       off))
                    : (java.nio.LongBuffer)(new ByteBufferAsLongBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? (java.nio.LongBuffer)(new DirectLongBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
        ...
        if (!unaligned && ((address + off) % (1 << 2) != 0)) {
            return (bigEndian
                    ? (java.nio.FloatBuffer)(new ByteBufferAsFloatBufferB(this,
                                                                       ...
                                                                       size,
                                                                       off))
                    : (java.nio.FloatBuffer)(new ByteBufferAsFloatBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? (java.nio.FloatBuffer)(new DirectFloatBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
        ...
        if (!unaligned && ((address + off) % (1 << 3) != 0)) {
            return (bigEndian
                    ? (java.nio.DoubleBuffer)(new ByteBufferAsDoubleBufferB(this,
                                                                       ...
                                                                       size,
                                                                       off))
                    : (java.nio.DoubleBuffer)(new ByteBufferAsDoubleBufferL(this,
                                                                       -1,
                                                                       0,
                                                                       size,
                                                                       size,
            ...
            return (nativeByteOrder
                    ? (java.nio.DoubleBuffer)(new DirectDoubleBufferU(this,
                                                                 -1,
                                                                 0,
                                                                 size,
                                                                 size,
