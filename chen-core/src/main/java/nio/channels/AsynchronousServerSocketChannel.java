 ...
 * the {@link #accept(Object, java.nio.channels.CompletionHandler) accept} method
 * is used to initiate the accepting of connections to the channel's socket.
 * An attempt to invoke the <tt>accept</tt> method on an unbound channel will
 * cause a {@link java.nio.channels.NotYetBoundException} to be thrown.
 *
 ...
 * has completed then an {@link java.nio.channels.AcceptPendingException} will be thrown.
 *
    ...
    implements AsynchronousChannel, NetworkChannel
{
     ...
     */
    public static AsynchronousServerSocketChannel open(java.nio.channels.AsynchronousChannelGroup group)
        throws IOException
    {
     ...
     * the {@link java.nio.channels.AsynchronousSocketChannel} to the new connection.
     *
     * <p> When a new connection is accepted then the resulting {@code
     * AsynchronousSocketChannel} will be bound to the same {@link
     * java.nio.channels.AsynchronousChannelGroup} as this channel. If the group is {@link
     ...
     * IOException} and cause {@link java.nio.channels.ShutdownChannelGroupException}.
     *
     ...
     * java.nio.channels.AsynchronousSocketChannel} to the new connection on successful completion.
     *
