    ...
    implements AsynchronousChannel
{
     ...
     * {@link #lock(Object, java.nio.channels.CompletionHandler)} method simply locks a region
     ...
     * java.nio.channels.FileLock#isShared() isShared} method.
     *
     ...
     * <pre>
     *     ch.{@link #lock(long,long,boolean,Object, java.nio.channels.CompletionHandler) lock}(0L, Long.MAX_VALUE, false, att, handler)
     * </pre>
     *
     * @param   <A>
     *          The type of the attachment
     ...
     * java.nio.channels.FileLock} on successful completion.
     *
     * @param   position
     *          The position at which the locked region is to start; must be
     *          non-negative
     ...
     *          If {@code shared} is false but this channel was not opened for writing
     */
    public abstract Future<java.nio.channels.FileLock> lock(long position, long size, boolean shared);
     ...
     *          If this channel was not opened for writing
     */
    public final Future<java.nio.channels.FileLock> lock() {
     ...
     *          If some other I/O error occurs
     *
     * @see     #lock(Object, java.nio.channels.CompletionHandler)
     * @see     #lock(long,long,boolean,Object, java.nio.channels.CompletionHandler)
     * @see     #tryLock()
     */
    public abstract java.nio.channels.FileLock tryLock(long position, long size, boolean shared)
        throws IOException;
     ...
     * java.nio.channels.AsynchronousByteChannel#read(ByteBuffer,Object, java.nio.channels.CompletionHandler)}
     ...
     *
     * <p> This method works in the same manner as the {@link
     * java.nio.channels.AsynchronousByteChannel#read(ByteBuffer)} method, except that bytes are
     ...
     *
     * <p> This method works in the same manner as the {@link
     * java.nio.channels.AsynchronousByteChannel#write(ByteBuffer,Object, java.nio.channels.CompletionHandler)}
