 ...
 * <h2>Timeouts</h2>
 *
 * <p> The {@link #read(ByteBuffer,long,TimeUnit,Object, java.nio.channels.CompletionHandler) read}
 * and {@link #write(ByteBuffer,long,TimeUnit,Object, java.nio.channels.CompletionHandler) write}
...
public abstract class AsynchronousSocketChannel
    implements java.nio.channels.AsynchronousByteChannel, NetworkChannel
{
    ...
    public abstract <A> void connect(SocketAddress remote,
                                     A attachment,
                                     java.nio.channels.CompletionHandler<Void,? super A> handler);
     ...
     * #connect(SocketAddress, Object, java.nio.channels.CompletionHandler)} method except that
    ...
    public abstract <A> void read(ByteBuffer[] dsts,
                                  ...
                                  TimeUnit unit,
                                  A attachment,
                                  java.nio.channels.CompletionHandler<Long,? super A> handler);
     ...
     *
     * <p> Otherwise this method works in the same manner as the {@link
     * AsynchronousByteChannel#write(ByteBuffer,Object, java.nio.channels.CompletionHandler)}
     * method.
     *
     * @param   <A>
     *          The type of the attachment
