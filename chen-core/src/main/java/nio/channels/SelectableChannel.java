 ...
 * first be <i>registered</i> via the {@link #register(java.nio.channels.Selector,int,Object)
 ...
 * java.nio.channels.SelectionKey#cancel() cancel} method.  All of a channel's keys are cancelled
    ...
    implements Channel
{
     ...
     *          the given selector
     */
    public abstract java.nio.channels.SelectionKey register(java.nio.channels.Selector sel, int ops, Object att)
        throws ClosedChannelException;
    //
    // sync(regLock) {
     ...
     * #register(java.nio.channels.Selector,int, Object)
