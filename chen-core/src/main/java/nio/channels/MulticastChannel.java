 ...
 * java.nio.channels.MembershipKey#drop drop} method on the returned {@link java.nio.channels.MembershipKey}. If the
 ...
 * java.nio.channels.MembershipKey#drop drop} method drops membership so that datagrams from the
    ...
    extends NetworkChannel
{
     ...
     * is {@link java.nio.channels.MembershipKey#drop dropped}. Upon return, the {@link
     * java.nio.channels.MembershipKey membership-key} will be {@link java.nio.channels.MembershipKey#isValid
     * invalid}.
     *
     ...
     */
    java.nio.channels.MembershipKey join(InetAddress group, NetworkInterface interf)
        throws IOException;
