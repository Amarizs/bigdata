 ...
 * operation has completed then a {@link java.nio.channels.ReadPendingException} will be thrown.
 * Similarly, if a write method is invoked before a previous write has completed
 * then {@link java.nio.channels.WritePendingException} is thrown. Whether or not other kinds of
 ...
 * operation completes.
 *
 * @see java.nio.channels.Channels#newInputStream(AsynchronousByteChannel)
    ...
    extends AsynchronousChannel
{
     ...
     * completed then a {@link java.nio.channels.ReadPendingException} will be thrown.
     *
     * @param   <A>
     ...
     * #read(ByteBuffer,Object, java.nio.channels.CompletionHandler)
