    ...
    extends java.nio.IntBuffer
{
    ...
    ByteBufferAsIntBufferB(java.nio.ByteBuffer bb) {   // package-private
    ...
    ByteBufferAsIntBufferB(java.nio.ByteBuffer bb,
    ...
    public int get() {
        return java.nio.Bits.getIntB(bb, ix(nextGetIndex()));
    }

    public int get(int i) {
        return java.nio.Bits.getIntB(bb, ix(checkIndex(i)));
    }
    ...
    public java.nio.IntBuffer put(int x) {
        ...
        java.nio.Bits.putIntB(bb, ix(nextPutIndex()), x);
        return this;
    ...
    public java.nio.IntBuffer put(int i, int x) {
        ...
        java.nio.Bits.putIntB(bb, ix(checkIndex(i)), x);
        return this;
