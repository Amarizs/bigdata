...
public final class Float extends Number implements Comparable<Float> {
    ...
    public static final java.lang.Class<Float> TYPE = (java.lang.Class<Float>) java.lang.Class.getPrimitiveClass("float");
    ...
    public static String toHexString(float f) {
        if (java.lang.Math.abs(f) < FloatConsts.MIN_NORMAL
            ...
            // exponent
            String s = Double.toHexString(java.lang.Math.scalb((double)f,
                                                     /* -1022+126 */
