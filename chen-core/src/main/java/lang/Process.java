 ...
 * {@link Runtime#exec(java.lang.String[], java.lang.String[],File) Runtime.exec}
            ...
            try {
                ...
                if (rem > 0)
                    java.lang.Thread.sleep(
                        java.lang.Math.min(TimeUnit.NANOSECONDS.toMillis(rem) + 1, 100));
            }
            rem = unit.toNanos(timeout) - (java.lang.System.nanoTime() - startTime);
        } while (rem > 0);
        return false;
    }
