...
/**
 * A {@code ConstantCallSite} is a {@link java.lang.invoke.CallSite} whose target is permanent, and can never be changed.
...
public class ConstantCallSite extends java.lang.invoke.CallSite {
     ...
     */
    protected ConstantCallSite(MethodType targetType, java.lang.invoke.MethodHandle createTargetHook) throws Throwable {
     ...
     */
    @Override public final java.lang.invoke.MethodHandle getTarget() {
     ...
     */
    @Override public final void setTarget(java.lang.invoke.MethodHandle ignore) {
