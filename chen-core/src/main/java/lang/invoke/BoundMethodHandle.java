...
/*non-public*/ abstract class BoundMethodHandle extends java.lang.invoke.MethodHandle {
    ...
    /*non-public*/ static SpeciesData speciesData(java.lang.invoke.LambdaForm form) {
    ...
    static final class Species_L extends BoundMethodHandle {
        ...
        /*non-public*/ static final java.lang.invoke.BoundMethodHandle.SpeciesData SPECIES_DATA = new java.lang.invoke.BoundMethodHandle.SpeciesData("L", java.lang.invoke.BoundMethodHandle.Species_L.class);
    ...
    static class SpeciesData {
        ...
        private final java.lang.invoke.MethodHandle[]             constructor;
        @java.lang.invoke.Stable
        private final java.lang.invoke.MethodHandle[]             getters;
        @java.lang.invoke.Stable
        ...
        java.lang.invoke.MethodHandle[] getterHandles() { return getters; }
        ...
        SpeciesData(String types, Class<? extends BoundMethodHandle> clazz) {
            ...
            this.clazz = clazz;
            if (!INIT_DONE) {
                this.constructor = new java.lang.invoke.MethodHandle[1];  // only one ctor
                this.getters = new java.lang.invoke.MethodHandle[types.length()];
    ...
    static class Factory {
        ...
        static Class<? extends BoundMethodHandle> generateConcreteBMHClass(String types) {
            ...
            String shortTypes = java.lang.invoke.LambdaForm.shortenSignature(types);
        ...
        private static java.lang.invoke.MethodHandle makeGetter(Class<?> cbmhClass, String types, int index) {
        ...
        static java.lang.invoke.MethodHandle[] makeGetters(Class<?> cbmhClass, String types, java.lang.invoke.MethodHandle[] mhs) {
            if (mhs == null)  mhs = new java.lang.invoke.MethodHandle[types.length()];
        ...
        static java.lang.invoke.MethodHandle[] makeCtors(Class<? extends BoundMethodHandle> cbmh, String types, java.lang.invoke.MethodHandle mhs[]) {
            if (mhs == null)  mhs = new java.lang.invoke.MethodHandle[1];
            if (types.equals(""))  return mhs;  // hack for empty BMH species
            mhs[0] = makeCbmhCtor(cbmh, types);
            return mhs;
        }

        static NamedFunction[] makeNominalGetters(String types, NamedFunction[] nfs, java.lang.invoke.MethodHandle[] getters) {
        ...
        static void setSpeciesDataToConcreteBMHClass(Class<? extends BoundMethodHandle> cbmh, SpeciesData speciesData) {
            try {
                Field F_SPECIES_DATA = cbmh.getDeclaredField("SPECIES_DATA");
                assert F_SPECIES_DATA.getDeclaredAnnotation(java.lang.invoke.Stable.class) != null;
