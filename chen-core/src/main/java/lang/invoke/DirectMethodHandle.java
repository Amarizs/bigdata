 ...
 * @author jrose
 */
class DirectMethodHandle extends java.lang.invoke.MethodHandle {
    final java.lang.invoke.MemberName member;

    // Constructors and factory methods in this class *must* be package scoped or private.
    private DirectMethodHandle(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName member) {
        super(mtype, form);
        ...
        if (member.getDeclaringClass().isInterface() &&
            ...
            java.lang.invoke.MemberName m = new java.lang.invoke.MemberName(Object.class, member.getName(), member.getMethodType(), member.getReferenceKind());
            m = java.lang.invoke.MemberName.getFactory().resolveOrNull(m.getReferenceKind(), m, null);
    ...
    // Factory methods:
    static DirectMethodHandle make(byte refKind, Class<?> receiver, java.lang.invoke.MemberName member) {
        java.lang.invoke.MethodType mtype = member.getMethodOrFieldType();
        if (!member.isStatic()) {
        ...
        if (!member.isField()) {
            switch (refKind) {
                case REF_invokeSpecial: {
                    ...
                    java.lang.invoke.LambdaForm lform = preparedLambdaForm(member);
            ...
            java.lang.invoke.LambdaForm lform = preparedFieldLambdaForm(member);
            if (member.isStatic()) {
    ...
    static DirectMethodHandle make(Class<?> receiver, java.lang.invoke.MemberName member) {
        byte refKind = member.getReferenceKind();
        if (refKind == REF_invokeSpecial)
            refKind =  REF_invokeVirtual;
        return make(refKind, receiver, member);
    }
    static DirectMethodHandle make(java.lang.invoke.MemberName member) {
        if (member.isConstructor())
            return makeAllocator(member);
        return make(member.getDeclaringClass(), member);
    }
    static DirectMethodHandle make(Method method) {
        return make(method.getDeclaringClass(), new java.lang.invoke.MemberName(method));
    }
    static DirectMethodHandle make(Field field) {
        return make(field.getDeclaringClass(), new java.lang.invoke.MemberName(field));
    }
    private static DirectMethodHandle makeAllocator(java.lang.invoke.MemberName ctor) {
        assert(ctor.isConstructor() && ctor.getName().equals("<init>"));
        Class<?> instanceClass = ctor.getDeclaringClass();
        ctor = ctor.asConstructor();
        assert(ctor.isConstructor() && ctor.getReferenceKind() == REF_newInvokeSpecial) : ctor;
        java.lang.invoke.MethodType mtype = ctor.getMethodType().changeReturnType(instanceClass);
        java.lang.invoke.LambdaForm lform = preparedLambdaForm(ctor);
        java.lang.invoke.MemberName init = ctor.asSpecial();
    ...
    java.lang.invoke.BoundMethodHandle rebind() {
        return java.lang.invoke.BoundMethodHandle.makeReinvoker(this);
    }
     ...
     */
    private static java.lang.invoke.LambdaForm preparedLambdaForm(java.lang.invoke.MemberName m) {
        assert(m.isInvocable()) : m;  // call preparedFieldLambdaForm instead
        java.lang.invoke.MethodType mtype = m.getInvocationType().basicType();
        ...
        java.lang.invoke.LambdaForm lform = preparedLambdaForm(mtype, which);
    ...
    private static java.lang.invoke.LambdaForm preparedLambdaForm(java.lang.invoke.MethodType mtype, int which) {
    ...
    private static java.lang.invoke.LambdaForm makePreparedLambdaForm(java.lang.invoke.MethodType mtype, int which) {
        ...
        java.lang.invoke.MethodType mtypeWithArg = mtype.appendParameterTypes(java.lang.invoke.MemberName.class);
        if (doesAlloc)
            mtypeWithArg = mtypeWithArg
                    .insertParameterTypes(0, Object.class)  // insert newly allocated obj
                    .changeReturnType(void.class);          // <init> returns void
        java.lang.invoke.MemberName linker = new java.lang.invoke.MemberName(java.lang.invoke.MethodHandle.class, linkerName, mtypeWithArg, REF_invokeStatic);
        try {
        ...
        java.lang.invoke.LambdaForm lform = new java.lang.invoke.LambdaForm(lambdaName, ARG_LIMIT, names, result);
    ...
    private static void maybeCompile(java.lang.invoke.LambdaForm lform, java.lang.invoke.MemberName m) {
        if (VerifyAccess.isSamePackage(m.getDeclaringClass(), java.lang.invoke.MethodHandle.class))
    ...
    /*non-public*/ static
    boolean shouldBeInitialized(java.lang.invoke.MemberName member) {
    ...
    private static boolean checkInitialized(java.lang.invoke.MemberName member) {
    ...
    static class Special extends DirectMethodHandle {
        private Special(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName member) {
        ...
        @Override
        java.lang.invoke.MethodHandle copyWith(java.lang.invoke.MethodType mt, java.lang.invoke.LambdaForm lf) {
            return new java.lang.invoke.DirectMethodHandle.Special(mt, lf, member);
        }
    }
    ...
    static class Interface extends DirectMethodHandle {
        ...
        private Interface(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName member, Class<?> refc) {
            super(mtype, form, member);
        ...
        @Override
        java.lang.invoke.MethodHandle copyWith(java.lang.invoke.MethodType mt, java.lang.invoke.LambdaForm lf) {
            return new java.lang.invoke.DirectMethodHandle.Interface(mt, lf, member, refc);
        }
    ...
    static class Constructor extends DirectMethodHandle {
        final java.lang.invoke.MemberName initMethod;
        final Class<?>   instanceClass;

        private Constructor(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName constructor,
                            java.lang.invoke.MemberName initMethod, Class<?> instanceClass) {
        ...
        @Override
        java.lang.invoke.MethodHandle copyWith(java.lang.invoke.MethodType mt, java.lang.invoke.LambdaForm lf) {
            return new java.lang.invoke.DirectMethodHandle.Constructor(mt, lf, member, initMethod, instanceClass);
        }
    }
    ...
    static class Accessor extends DirectMethodHandle {
        ...
        private Accessor(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName member,
                         int fieldOffset) {
            super(mtype, form, member);
        ...
        @Override
        java.lang.invoke.MethodHandle copyWith(java.lang.invoke.MethodType mt, java.lang.invoke.LambdaForm lf) {
            return new java.lang.invoke.DirectMethodHandle.Accessor(mt, lf, member, fieldOffset);
        }
    }
    ...
    static class StaticAccessor extends DirectMethodHandle {
        ...
        private StaticAccessor(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName member,
        ...
        @Override
        MethodHandle copyWith(java.lang.invoke.MethodType mt, java.lang.invoke.LambdaForm lf) {
            return new java.lang.invoke.DirectMethodHandle.StaticAccessor(mt, lf, member, staticBase, staticOffset);
        }
    }
    ...
    private static final java.lang.invoke.LambdaForm[] ACCESSOR_FORMS
            = new java.lang.invoke.LambdaForm[afIndex(AF_LIMIT, false, 0)];
     ...
     * the same basicType and refKind.
     */
    private static java.lang.invoke.LambdaForm preparedFieldLambdaForm(java.lang.invoke.MemberName m) {
        ...
        java.lang.invoke.LambdaForm lform = preparedFieldLambdaForm(formOp, isVolatile, ftype);
        maybeCompile(lform, m);
        assert(lform.methodType().dropParameterTypes(0, 1)
                .equals(m.getInvocationType().basicType()))
                : Arrays.asList(m, m.getInvocationType().basicType(), lform, lform.methodType());
    ...
    private static java.lang.invoke.LambdaForm preparedFieldLambdaForm(byte formOp, boolean isVolatile, Class<?> ftype) {
        int afIndex = afIndex(formOp, isVolatile, ftypeKind(ftype));
        java.lang.invoke.LambdaForm lform = ACCESSOR_FORMS[afIndex];
        if (lform != null)  return lform;
    ...
    private static java.lang.invoke.LambdaForm makePreparedFieldLambdaForm(byte formOp, boolean isVolatile, int ftypeKind) {
        ...
        java.lang.invoke.MethodType linkerType;
        if (isGetter)
            linkerType = java.lang.invoke.MethodType.methodType(ft, Object.class, long.class);
        else
            linkerType = java.lang.invoke.MethodType.methodType(void.class, Object.class, long.class, ft);
        java.lang.invoke.MemberName linker = new java.lang.invoke.MemberName(Unsafe.class, linkerName, linkerType, REF_invokeVirtual);
        try {
        ...
        java.lang.invoke.MethodType mtype;
        if (isGetter)
            mtype = java.lang.invoke.MethodType.methodType(ft);
        else
        ...
        return new java.lang.invoke.LambdaForm(lambdaName, ARG_LIMIT, names, RESULT);
    }
        ...
        static {
            try {
                NamedFunction nfs[] = {
                        ...
                        NF_checkReceiver = new NamedFunction(new java.lang.invoke.MemberName(Interface.class
