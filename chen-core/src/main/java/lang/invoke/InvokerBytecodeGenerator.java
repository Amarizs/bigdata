...
class InvokerBytecodeGenerator {
    ...
    private static final java.lang.invoke.MemberName.Factory MEMBERNAME_FACTORY = java.lang.invoke.MemberName.getFactory();
    ...
    private InvokerBytecodeGenerator(java.lang.invoke.LambdaForm lambdaForm, int localsMapSize,
                                     String className, String invokerName, java.lang.invoke.MethodType invokerType) {
    ...
    private InvokerBytecodeGenerator(String className, String invokerName, java.lang.invoke.MethodType invokerType) {
    ...
    private InvokerBytecodeGenerator(String className, java.lang.invoke.LambdaForm form, java.lang.invoke.MethodType invokerType) {
    ...
    private static String debugString(Object arg) {
        if (arg instanceof java.lang.invoke.MethodHandle) {
            java.lang.invoke.MethodHandle mh = (java.lang.invoke.MethodHandle) arg;
            java.lang.invoke.MemberName member = mh.internalMemberName();
            if (member != null)
     ...
     */
    private java.lang.invoke.MemberName loadMethod(byte[] classFile) {
    ...
    private static java.lang.invoke.MemberName resolveInvokerMember(Class<?> invokerClass, String name, java.lang.invoke.MethodType type) {
        java.lang.invoke.MemberName member = new java.lang.invoke.MemberName(invokerClass, name, type, REF_invokeStatic);
    ...
    private static String getInternalName(Class<?> c) {
        ...
        else if (c == java.lang.invoke.MethodHandle.class)  return MH;
    ...
    /**
     * Generate an invoker method for the passed {@link java.lang.invoke.LambdaForm}.
     */
    private byte[] generateCustomizedCodeBytes() {
        ...
        for (int i = lambdaForm.arity; i < lambdaForm.names.length; i++) {
                ...
                case SELECT_ALTERNATIVE:
                    ...
                    if (PROFILE_GWT) {
                        assert(name.arguments[0] instanceof Name &&
                               nameRefersTo((Name)name.arguments[0], java.lang.invoke.MethodHandleImpl.class, "profileBoolean"));
            ...
            java.lang.invoke.MemberName member = name.function.member();
    ...
    void emitInvoke(Name name) {
        ...
        if (true) {
            // push receiver
            java.lang.invoke.MethodHandle target = name.function.resolvedHandle;
            assert(target != null) : name.exprString();
            mv.visitLdcInsn(constantPlaceholder(target));
            emitReferenceCast(java.lang.invoke.MethodHandle.class, target);
        } else {
            // load receiver
            emitAloadInsn(0);
            emitReferenceCast(java.lang.invoke.MethodHandle.class, null);
    ...
    static boolean isStaticallyInvocable(java.lang.invoke.MemberName member) {
        ...
        if (cls.getClassLoader() != java.lang.invoke.MethodHandle.class.getClassLoader())
        ...
        for (Class<?> ptype : mtype.parameterArray())
            if (!isStaticallyNameable(ptype))
                return false;
        if (!member.isPrivate() && VerifyAccess.isSamePackage(java.lang.invoke.MethodHandle.class, cls))
    ...
    void emitStaticInvoke(java.lang.invoke.MemberName member, Name name) {
        ...
        if (member.isMethod()) {
            ...
            mtype = java.lang.invoke.MethodType.toFieldDescriptorString(member.getFieldType());
     ...
     */
    private boolean memberRefersTo(java.lang.invoke.MemberName member, Class<?> declaringClass, String name) {
        return member != null &&
    ...
    private boolean isInvokeBasic(Name name) {
        ...
        java.lang.invoke.MemberName member = name.function.member();
        return memberRefersTo(member, java.lang.invoke.MethodHandle.class, "invokeBasic") &&
    ...
    private boolean isLinkerMethodInvoke(Name name) {
        ...
        java.lang.invoke.MemberName member = name.function.member();
        return member != null &&
               member.getDeclaringClass() == java.lang.invoke.MethodHandle.class &&
               !member.isPublic() && member.isStatic() &&
    ...
    private boolean isSelectAlternative(int pos) {
        ...
        return nameRefersTo(name0, java.lang.invoke.MethodHandleImpl.class, "selectAlternative") &&
               isInvokeBasic(name1) &&
    ...
    private boolean isGuardWithCatch(int pos) {
        ...
        return nameRefersTo(name1, java.lang.invoke.MethodHandleImpl.class, "guardWithCatch") &&
               isInvokeBasic(name0) &&
               isInvokeBasic(name2) &&
    ...
    private Name emitGuardWithCatch(int pos) {
        ...
        java.lang.invoke.MethodType type = args.function.resolvedHandle.type()
        ...
        mv.visitInsn(Opcodes.SWAP);
        emitPushArguments(args, 1); // skip 1st argument: method handle
        java.lang.invoke.MethodType catcherType = type.insertParameterTypes(0, Throwable.class);
     ...
     */
    static java.lang.invoke.MemberName generateLambdaFormInterpreterEntryPoint(String sig) {
        assert(isValidSignature(sig));
        String name = "interpret_"+signatureReturn(sig).basicTypeChar();
        java.lang.invoke.MethodType type = signatureType(sig);  // sig includes leading argument
    ...
    static java.lang.invoke.MemberName generateNamedFunctionInvoker(java.lang.invoke.MethodTypeForm typeForm) {
        java.lang.invoke.MethodType invokerType = NamedFunction.INVOKER_METHOD_TYPE;
