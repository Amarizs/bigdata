...
class InfoFromMemberName implements java.lang.invoke.MethodHandleInfo {
    ...
    InfoFromMemberName(Lookup lookup, java.lang.invoke.MemberName member, byte referenceKind) {
    ...
    private static java.lang.invoke.MemberName convertToMemberName(byte refKind, Member mem) throws IllegalAccessException {
        if (mem instanceof Method) {
            boolean wantSpecial = (refKind == REF_invokeSpecial);
            return new java.lang.invoke.MemberName((Method) mem, wantSpecial);
        } else if (mem instanceof Constructor) {
            return new java.lang.invoke.MemberName((Constructor) mem);
        } else if (mem instanceof Field) {
            boolean isSetter = (refKind == REF_putField || refKind == REF_putStatic);
            return new java.lang.invoke.MemberName((Field) mem, isSetter);
        }
