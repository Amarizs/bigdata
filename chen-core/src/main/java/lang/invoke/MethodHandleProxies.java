...
public class MethodHandleProxies {
    ...
    @CallerSensitive
    public static
    <T> T asInterfaceInstance(final Class<T> intfc, final java.lang.invoke.MethodHandle target) {
        if (!intfc.isInterface() || !Modifier.isPublic(intfc.getModifiers()))
            throw newIllegalArgumentException("not a public interface", intfc.getName());
        final java.lang.invoke.MethodHandle mh;
        ...
        final java.lang.invoke.MethodHandle[] vaTargets = new java.lang.invoke.MethodHandle[methods.length];
        for (int i = 0; i < methods.length; i++) {
            Method sm = methods[i];
            java.lang.invoke.MethodType smMT = java.lang.invoke.MethodType.methodType(sm.getReturnType(), sm.getParameterTypes());
            java.lang.invoke.MethodHandle checkTarget = mh.asType(smMT);  // make throw WMT
    ...
    private static java.lang.invoke.MethodHandle bindCaller(java.lang.invoke.MethodHandle target, Class<?> hostClass) {
        java.lang.invoke.MethodHandle cbmh = java.lang.invoke.MethodHandleImpl.bindCaller(target, hostClass);
