...
public abstract class MethodHandle {
    ...
    /*private*/ final java.lang.invoke.LambdaForm form;
    ...
    /*non-public*/ MethodHandle(java.lang.invoke.MethodType type, java.lang.invoke.LambdaForm form) {
    ...
    public Object invokeWithArguments(Object... arguments) throws Throwable {
        java.lang.invoke.MethodType invocationType = java.lang.invoke.MethodType.genericMethodType(arguments == null ? 0 : arguments.length);
     ...
     */
    public MethodHandle asType(java.lang.invoke.MethodType newType) {
    ...
    private MethodHandle asTypeCached(java.lang.invoke.MethodType newType) {
    ...
    /*non-public*/ MethodHandle asTypeUncached(java.lang.invoke.MethodType newType) {
...
assertEquals("[A, B, C]", (String) caToString2.invokeExact('A', "BC".toCharArray()));
    ...
    public MethodHandle asSpreader(Class<?> arrayType, int arrayLength) {
        java.lang.invoke.MethodType postSpreadType = asSpreaderChecks(arrayType, arrayLength);
        int arity = type().parameterCount();
        int spreadArgPos = arity - arrayLength;
        MethodHandle afterSpread = this.asType(postSpreadType);
        BoundMethodHandle mh = afterSpread.rebind();
        java.lang.invoke.LambdaForm lform = mh.editor().spreadArgumentsForm(1 + spreadArgPos, arrayType, arrayLength);
        java.lang.invoke.MethodType preSpreadType = postSpreadType.replaceParameterTypes(spreadArgPos, arity, arrayType);
     ...
     */
    private java.lang.invoke.MethodType asSpreaderChecks(Class<?> arrayType, int arrayLength) {
        spreadArrayChecks(arrayType, arrayLength);
        int nargs = type().parameterCount();
        if (nargs < arrayLength || arrayLength < 0)
            throw newIllegalArgumentException("bad spread array length");
        Class<?> arrayElement = arrayType.getComponentType();
        java.lang.invoke.MethodType mtype = type();
        boolean match = true, fail = false;
        for (int i = nargs - arrayLength; i < nargs; i++) {
            Class<?> ptype = mtype.parameterType(i);
            if (ptype != arrayElement) {
                match = false;
                if (!java.lang.invoke.MethodType.canConvert(arrayElement, ptype)) {
                    fail = true;
                    break;
                }
            }
        ...
        java.lang.invoke.MethodType needType = mtype.asSpreaderType(arrayType, arrayLength);
...
assertEquals("[123]", (String) longsToString.invokeExact((long)123));
    ...
    public MethodHandle asCollector(Class<?> arrayType, int arrayLength) {
        ...
        java.lang.invoke.LambdaForm lform = mh.editor().collectArgumentArrayForm(1 + collectArgPos, newArray);
        if (lform != null) {
...
assertEquals("[three, thee, tee]", asListFix.invoke((Object)argv).toString());
    ...
    /*non-public*/
    MethodHandle setVarargs(java.lang.invoke.MemberName member) throws IllegalAccessException {
    ...
    /*non-public*/
    MethodHandle viewAsType(java.lang.invoke.MethodType newType, boolean strict) {
    ...
    /*non-public*/
    MethodHandle withInternalMemberName(java.lang.invoke.MemberName member, boolean isInvokeSpecial) {
        if (member != null) {
    ...
    /*non-public*/
    abstract MethodHandle copyWith(MethodType mt, java.lang.invoke.LambdaForm lf);
     ...
     */
    /*non-public*/
    void updateForm(java.lang.invoke.LambdaForm newForm) {
    ...
    void customize() {
        if (form.customized == null) {
            java.lang.invoke.LambdaForm newForm = form.customize(this);
            updateForm(newForm);
        } else {
