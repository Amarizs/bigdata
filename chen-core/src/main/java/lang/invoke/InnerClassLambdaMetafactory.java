...
/* package */ final class InnerClassLambdaMetafactory extends AbstractValidatingLambdaMetafactory {
    ...
    private static final String DESCR_CTOR_NOT_SERIALIZABLE_EXCEPTION
            = java.lang.invoke.MethodType.methodType(void.class, String.class).toMethodDescriptorString();
    ...
    static {
        ...
        dumper = (null == path) ? null : java.lang.invoke.ProxyClassesDumper.getInstance(path);
    }
    ...
    private final java.lang.invoke.MethodType constructorType;        // Generated class constructor type "(CC)void"
     ...
     */
    public InnerClassLambdaMetafactory(java.lang.invoke.MethodHandles.Lookup caller,
        ...
        implMethodReturnClass = (implKind == java.lang.invoke.MethodHandleInfo.REF_newInvokeSpecial)
                ? implDefiningClass
     ...
     * @throws java.lang.invoke.LambdaConversionException If properly formed functional interface
     * is not found
     */
    @Override
    CallSite buildCallSite() throws java.lang.invoke.LambdaConversionException {
        ...
        if (invokedType.parameterCount() == 0) {
            ...
            if (ctrs.length != 1) {
                throw new java.lang.invoke.LambdaConversionException("Expected one lambda constructor for "
                        + innerClass.getCanonicalName() + ", got " + ctrs.length);
            }

            try {
                Object inst = ctrs[0].newInstance();
                return new java.lang.invoke.ConstantCallSite(java.lang.invoke.MethodHandles.constant(samBase, inst));
            }
            catch (ReflectiveOperationException e) {
                throw new java.lang.invoke.LambdaConversionException("Exception instantiating lambda object", e);
            }
        } else {
            try {
                ...
                throw new java.lang.invoke.LambdaConversionException("Exception finding constructor", e);
            }
        }
    }
    ...
    private Class<?> spinInnerClass() throws LambdaConversionException {
        ...
        if (additionalBridges != null) {
            for (java.lang.invoke.MethodType mt : additionalBridges) {
    ...
    private class ForwardingMethodGenerator extends TypeConvertingMethodAdapter {
        ...
        void generate(java.lang.invoke.MethodType methodType) {
            visitCode();

            if (implKind == java.lang.invoke.MethodHandleInfo.REF_newInvokeSpecial) {
