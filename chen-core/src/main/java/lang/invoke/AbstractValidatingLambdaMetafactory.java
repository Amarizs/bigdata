...
/* package */ abstract class AbstractValidatingLambdaMetafactory {
    ...
    final java.lang.invoke.MethodType invokedType;             // The type of the invoked method "(CC)II"
    final Class<?> samBase;                   // The type of the returned instance "interface JJ"
    final String samMethodName;               // Name of the SAM method "foo"
    final java.lang.invoke.MethodType samMethodType;           // Type of the SAM method "(Object)Object"
    final java.lang.invoke.MethodHandle implMethod;            // Raw method handle for the implementation method
    final java.lang.invoke.MethodHandleInfo implInfo;          // Info about the implementation method handle "MethodHandleInfo[5 CC.impl(int)String]"
    ...
    final java.lang.invoke.MethodType implMethodType;          // Type of the implementation method "(int)String"
    final java.lang.invoke.MethodType instantiatedMethodType;  // Instantiated erased functional interface method type "(Integer)Object"
    final boolean isSerializable;             // Should the returned instance be serializable
    final Class<?>[] markerInterfaces;        // Additional marker interfaces to be implemented
    final java.lang.invoke.MethodType[] additionalBridges;     // Signatures of additional methods to bridge
     ...
     * @throws java.lang.invoke.LambdaConversionException If any of the meta-factory protocol
     * invariants are violated
     */
    AbstractValidatingLambdaMetafactory(java.lang.invoke.MethodHandles.Lookup caller,
                                        ...
                                        java.lang.invoke.MethodType[] additionalBridges)
            throws java.lang.invoke.LambdaConversionException {
        if ((caller.lookupModes() & MethodHandles.Lookup.PRIVATE) == 0) {
            throw new java.lang.invoke.LambdaConversionException(String.format(
                    "Invalid caller: %s",
        ...
        this.implIsInstanceMethod =
                implKind == java.lang.invoke.MethodHandleInfo.REF_invokeVirtual ||
                implKind == java.lang.invoke.MethodHandleInfo.REF_invokeSpecial ||
                implKind == java.lang.invoke.MethodHandleInfo.REF_invokeInterface;
     ...
     * @throws java.lang.invoke.LambdaConversionException if there are improper conversions
     */
    void validateMetafactoryArgs() throws java.lang.invoke.LambdaConversionException {
        switch (implKind) {
            case java.lang.invoke.MethodHandleInfo.REF_invokeInterface:
            case java.lang.invoke.MethodHandleInfo.REF_invokeVirtual:
            case java.lang.invoke.MethodHandleInfo.REF_invokeStatic:
            case java.lang.invoke.MethodHandleInfo.REF_newInvokeSpecial:
            case java.lang.invoke.MethodHandleInfo.REF_invokeSpecial:
                break;
            default:
                throw new java.lang.invoke.LambdaConversionException(String.format("Unsupported MethodHandle kind: %s", implInfo));
        }
        ...
        if (implArity + receiverArity != capturedArity + samArity) {
            throw new java.lang.invoke.LambdaConversionException(
        ...
        for (java.lang.invoke.MethodType bridgeMT : additionalBridges) {
