...
class LambdaFormEditor {
    ...
    private LambdaFormEditor(java.lang.invoke.LambdaForm lambdaForm) {
        this.lambdaForm = lambdaForm;
    }

    // Factory method.
    static LambdaFormEditor lambdaFormEditor(java.lang.invoke.LambdaForm lambdaForm) {
     ...
     */
    private static final class Transform extends SoftReference<java.lang.invoke.LambdaForm> {
        ...
        private Transform(long packedBytes, byte[] fullBytes, java.lang.invoke.LambdaForm result) {
            super(result);
        ...
        Transform withResult(java.lang.invoke.LambdaForm result) {
        ...
        public String toString() {
            ...
            java.lang.invoke.LambdaForm result = get();
            if (result != null) {
                buf.append(" result=");
                buf.append(result);
            }
    ...
    private java.lang.invoke.LambdaForm getInCache(Transform key) {
        assert(key.get() == null);
     ...
     */
    private java.lang.invoke.LambdaForm putInCache(Transform key, java.lang.invoke.LambdaForm form) {
        ...
        for (int pass = 0; ; pass++) {
            ...
            if (c instanceof ConcurrentHashMap) {
                ...
                java.lang.invoke.LambdaForm result = k.get();
                if (result != null) {
                    return result;
                } else {
    ...
    private java.lang.invoke.LambdaFormBuffer buffer() {
        return new java.lang.invoke.LambdaFormBuffer(lambdaForm);
    }
    ...
    BoundMethodHandle bindArgumentL(BoundMethodHandle mh, int pos, Object value) {
        ...
        BasicType bt = L_TYPE;
        java.lang.invoke.MethodType type2 = bindArgumentType(mh, pos, bt);
        java.lang.invoke.LambdaForm form2 = bindArgumentForm(1+pos);
    ...
    private java.lang.invoke.MethodType bindArgumentType(BoundMethodHandle mh, int pos, BasicType bt) {
    ...
    java.lang.invoke.LambdaForm bindArgumentForm(int pos) {
        Transform key = Transform.of(Transform.Kind.BIND_ARG, pos);
        java.lang.invoke.LambdaForm form = getInCache(key);
        if (form != null) {
            assert(form.parameterConstraint(0) == newSpeciesData(lambdaForm.parameterType(pos)));
            return form;
        }
        java.lang.invoke.LambdaFormBuffer buf = buffer();
        buf.startEdit();
    ...
    java.lang.invoke.LambdaForm addArgumentForm(int pos, BasicType type) {
    ...
    java.lang.invoke.LambdaForm dupArgumentForm(int srcPos, int dstPos) {
    ...
    java.lang.invoke.LambdaForm spreadArgumentsForm(int pos, Class<?> arrayType, int arrayLength) {
        ...
        assert(pos <= java.lang.invoke.MethodType.MAX_JVM_ARITY);
        ...
        java.lang.invoke.MethodHandle aload = MethodHandles.arrayElementGetter(erasedArrayType);
    ...
    java.lang.invoke.LambdaForm collectArgumentsForm(int pos, java.lang.invoke.MethodType collectorType) {
    ...
    java.lang.invoke.LambdaForm collectArgumentArrayForm(int pos, MethodHandle arrayCollector) {
        java.lang.invoke.MethodType collectorType = arrayCollector.type();
        int collectorArity = collectorType.parameterCount();
    ...
    java.lang.invoke.LambdaForm filterArgumentForm(int pos, BasicType newType) {
        ...
        java.lang.invoke.MethodType filterType = java.lang.invoke.MethodType.methodType(oldType.basicTypeClass(),
                newType.basicTypeClass());
        form = makeArgumentCombinationForm(pos, filterType, false, false);
        return putInCache(key, form);
    }

    private java.lang.invoke.LambdaForm makeArgumentCombinationForm(int pos,
    ...
    java.lang.invoke.LambdaForm filterReturnForm(BasicType newType, boolean constantZero) {
        ...
        if (constantZero) {
            ...
            if (oldType == V_TYPE) {
                java.lang.invoke.MethodType filterType = java.lang.invoke.MethodType.methodType(newType.basicTypeClass());
                callFilter = new Name(filterType, getFilter);
            } else {
                java.lang.invoke.MethodType filterType = java.lang.invoke.MethodType.methodType(newType.basicTypeClass(), oldType.basicTypeClass());
    ...
    java.lang.invoke.LambdaForm foldArgumentsForm(int foldPos, boolean dropResult, MethodType combinerType) {
        int combinerArity = combinerType.parameterCount();
    ...
    java.lang.invoke.LambdaForm permuteArgumentsForm(int skip, int[] reorder) {
        ...
        form = new java.lang.invoke.LambdaForm(lambdaForm.debugName, arity2, names2, result2);
        return putInCache(key, form);
    }
