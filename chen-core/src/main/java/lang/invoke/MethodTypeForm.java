...
final class MethodTypeForm {
    ...
    final java.lang.invoke.MethodType erasedType;        // the canonical erasure
    final java.lang.invoke.MethodType basicType;         // the canonical erasure, with primitives simplified

    // Cached adapter information:
    @java.lang.invoke.Stable
    final SoftReference<java.lang.invoke.MethodHandle>[] methodHandles;
    ...
    SoftReference<java.lang.invoke.LambdaForm>[] lambdaForms;
    ...
    public java.lang.invoke.MethodHandle cachedMethodHandle(int which) {
        assert(assertIsBasicType());
        SoftReference<java.lang.invoke.MethodHandle> entry = methodHandles[which];
        return (entry != null) ? entry.get() : null;
    }

    synchronized public java.lang.invoke.MethodHandle setCachedMethodHandle(int which, java.lang.invoke.MethodHandle mh) {
    ...
    public java.lang.invoke.LambdaForm cachedLambdaForm(int which) {
        assert(assertIsBasicType());
        SoftReference<java.lang.invoke.LambdaForm> entry = lambdaForms[which];
        return (entry != null) ? entry.get() : null;
    }

    synchronized public java.lang.invoke.LambdaForm setCachedLambdaForm(int which, java.lang.invoke.LambdaForm form) {
        // Simulate a CAS, to avoid racy duplication of results.
        SoftReference<java.lang.invoke.LambdaForm> entry = lambdaForms[which];
        if (entry != null) {
            java.lang.invoke.LambdaForm prev = entry.get();
            if (prev != null) {
                return prev;
            }
        }
    ...
    protected MethodTypeForm(java.lang.invoke.MethodType erasedType) {
        ...
        if (epts == bpts && bt == rt) {
            ...
            this.basicType = java.lang.invoke.MethodType.makeImpl(bt, bpts, true);
        ...
        if (lac != 0) {
            ...
            MethodTypeForm that = java.lang.invoke.MethodType.genericMethodType(ptypeCount).form();
            assert(this != that);
    ...
    static MethodTypeForm findForm(java.lang.invoke.MethodType mt) {
        java.lang.invoke.MethodType erased = canonicalize(mt, ERASE, ERASE);
        if (erased == null) {
     ...
     */
    public static java.lang.invoke.MethodType canonicalize(java.lang.invoke.MethodType mt, int howRet, int howArgs) {
