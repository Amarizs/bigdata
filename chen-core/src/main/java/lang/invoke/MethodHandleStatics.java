...
/*non-public*/ class MethodHandleStatics {
    ...
    /*non-public*/ static String getNameString(java.lang.invoke.MethodHandle target, java.lang.invoke.MethodType type) {
        if (type == null)
            type = target.type();
        java.lang.invoke.MemberName name = null;
        if (target != null)
    ...
    /*non-public*/ static String getNameString(java.lang.invoke.MethodHandle target, java.lang.invoke.MethodHandle typeHolder) {
        return getNameString(target, typeHolder == null ? (java.lang.invoke.MethodType) null : typeHolder.type());
    }

    /*non-public*/ static String getNameString(java.lang.invoke.MethodHandle target) {
