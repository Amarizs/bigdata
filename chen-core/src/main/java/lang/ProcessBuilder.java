...
{
    private List<java.lang.String> command;
    private File directory;
    private Map<java.lang.String, java.lang.String> environment;
     ...
     */
    public ProcessBuilder(List<java.lang.String> command) {
        if (command == null)
    ...
    public ProcessBuilder(java.lang.String... command) {
        ...
        for (java.lang.String arg : command)
     ...
     * @throws NullPointerException if the argument is null
     */
    public ProcessBuilder command(List<java.lang.String> command) {
        if (command == null)
            throw new NullPointerException();
        this.command = command;
        return this;
     ...
     */
    public List<java.lang.String> command() {
        return command;
    }
     ...
     * of type {@link java.lang.String} will throw a {@link ClassCastException}.
     *
     ...
     */
    public Map<java.lang.String, java.lang.String> environment() {
    ...
    ProcessBuilder environment(java.lang.String[] envp) {
        assert environment == null;
        if (envp != null) {
            environment = ProcessEnvironment.emptyEnvironment(envp.length);
            assert environment != null;

            for (java.lang.String envstring : envp) {
    ...
    public static abstract class Redirect {
        ...
        public static final Redirect PIPE = new Redirect() {
                public java.lang.ProcessBuilder.Redirect.Type type() { return java.lang.ProcessBuilder.Redirect.Type.PIPE; }
                public java.lang.String toString() { return type().toString(); }};
        ...
        public static final Redirect INHERIT = new Redirect() {
                public java.lang.ProcessBuilder.Redirect.Type type() { return java.lang.ProcessBuilder.Redirect.Type.INHERIT; }
                public java.lang.String toString() { return type().toString(); }};
        ...
        public static Redirect from(final File file) {
            if (file == null)
                throw new NullPointerException();
            return new Redirect() {
                    public java.lang.ProcessBuilder.Redirect.Type type() { return java.lang.ProcessBuilder.Redirect.Type.READ; }
        ...
        public static Redirect to(final File file) {
            if (file == null)
                throw new NullPointerException();
            return new Redirect() {
                    public java.lang.ProcessBuilder.Redirect.Type type() { return java.lang.ProcessBuilder.Redirect.Type.WRITE; }
                    public File file() { return file; }
                    public java.lang.String toString() {
        ...
        public static Redirect appendTo(final File file) {
            if (file == null)
                throw new NullPointerException();
            return new Redirect() {
                    public java.lang.ProcessBuilder.Redirect.Type type() { return java.lang.ProcessBuilder.Redirect.Type.APPEND; }
                    public File file() { return file; }
                    public java.lang.String toString() {
    ...
    public java.lang.Process start() throws IOException {
        ...
        java.lang.String[] cmdarray = command.toArray(new java.lang.String[command.size()]);
        cmdarray = cmdarray.clone();

        for (java.lang.String arg : cmdarray)
            if (arg == null)
                throw new NullPointerException();
        // Throws IndexOutOfBoundsException if command is empty
        java.lang.String prog = cmdarray[0];

        SecurityManager security = java.lang.System.getSecurityManager();
        if (security != null)
            security.checkExec(prog);

        java.lang.String dir = directory == null ? null : directory.toString();
        ...
        try {
            ...
            java.lang.String exceptionInfo = ": " + e.getMessage();
