...
public class ThreadInfo {
    ...
    private static java.lang.management.LockInfo[] EMPTY_SYNCS = new java.lang.management.LockInfo[0];
    ...
    private ThreadInfo(Thread t, int state, Object lockObj, Thread lockOwner,
        ...
        java.lang.management.LockInfo[] lockedSynchronizers;
        if (numSyncs == 0) {
            lockedSynchronizers = EMPTY_SYNCS;
        } else {
            lockedSynchronizers = new java.lang.management.LockInfo[numSyncs];
            for (int i = 0; i < numSyncs; i++) {
                Object lock = synchronizers[i];
                String className = lock.getClass().getName();
                int identityHashCode = System.identityHashCode(lock);
                lockedSynchronizers[i] = new java.lang.management.LockInfo(className,
                                                      identityHashCode);
            }
        }
    ...
    private void initialize(Thread t, int state, Object lockObj, Thread lockOwner,
        ...
        if (lockObj == null) {
            ...
            this.lock = new java.lang.management.LockInfo(lockObj);
            this.lockName =
                lock.getClassName() + '@' +
        ...
        if (ticd.isCurrentVersion()) {
            ...
            if (lockName != null) {
                ...
                if (result.length == 2) {
                    ...
                    lock = new java.lang.management.LockInfo(result[0], identityHashCode);
                } else {
    ...
    /**
     * Returns the {@link java.lang.management.LockInfo#toString string representation}
    ...
    public String toString() {
       ...
       java.lang.management.LockInfo[] locks = getLockedSynchronizers();
       if (locks.length > 0) {
           sb.append("\n\tNumber of locked synchronizers = " + locks.length);
           sb.append('\n');
           for (java.lang.management.LockInfo li : locks) {
               sb.append("\t- " + li);
               sb.append('\n');
           }
       }
     ...
     *       - the mapped type for {@link java.lang.management.LockInfo} as specified in the
     *         {@link java.lang.management.LockInfo#from} method.
     *       <p>
     ...
     *   <td><tt>javax.management.openmbean.CompositeData[]</tt>
     *       whose element type is the mapped type for
     *       {@link java.lang.management.LockInfo} as specified in the {@link java.lang.management.LockInfo#from} method.
     *       <p>
     *       If <tt>cd</tt> does not contain this attribute,
     *       this attribute will be set to an empty array. </td>
     * </tr>
    ...
    /**
     * Returns an array of {@link java.lang.management.LockInfo} objects, each of which
