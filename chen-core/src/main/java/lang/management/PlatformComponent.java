...
enum PlatformComponent {
    ...
    COMPILATION(
        ...
        true, // singleton
        new MXBeanFetcher<java.lang.management.CompilationMXBean>() {
            public List<java.lang.management.CompilationMXBean> getMXBeans() {
    ...
    MEMORY(
        ...
        true, // singleton
        new MXBeanFetcher<java.lang.management.MemoryMXBean>() {
    ...
    MEMORY_POOL(
        ...
        false, // zero or more instances
        new MXBeanFetcher<java.lang.management.MemoryPoolMXBean>() {
    ...
    RUNTIME(
        ...
        true, // singleton
        new MXBeanFetcher<java.lang.management.RuntimeMXBean>() {
    ...
    THREADING(
        ...
        true, // singleton
        new MXBeanFetcher<java.lang.management.ThreadMXBean>() {
    ...
    BUFFER_POOL(
        ...
        false, // zero or more instances
        new MXBeanFetcher<java.lang.management.BufferPoolMXBean>() {
        ...
        throws java.io.IOException
    {
        ...
        return java.lang.management.ManagementFactory.newPlatformMXBeanProxy(mbs,
                                                        on,
                                                        mxbeanInterface);
    }
