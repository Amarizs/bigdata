...
class ThreadGroup implements java.lang.Thread.UncaughtExceptionHandler {
    ...
    private ThreadGroup(java.lang.Void unused, ThreadGroup parent, java.lang.String name) {
        this.name = name;
     ...
     *                                thread in the specified thread group.
     */
    private static java.lang.Void checkParentAccess(ThreadGroup parent) {
        parent.checkAccess();
        return null;
    }
    ...
    private int enumerate(ThreadGroup list[], int n, boolean recurse) {
        ...
        synchronized (this) {
            ...
            if (ng > 0) {
                java.lang.System.arraycopy(groups, 0, list, n, ng);
                n += ng;
            }
            if (recurse) {
                ngroupsSnapshot = ngroups;
    ...
    private void remove(ThreadGroup g) {
        synchronized (this) {
            ...
            for (int i = 0 ; i < ngroups ; i++) {
                if (groups[i] == g) {
                    ngroups -= 1;
                    java.lang.System.arraycopy(groups, i + 1, groups, i, ngroups - i);
    ...
    private void remove(java.lang.Thread t) {
        synchronized (this) {
            ...
            for (int i = 0 ; i < nthreads ; i++) {
                if (threads[i] == t) {
                    java.lang.System.arraycopy(threads, i + 1, threads, i, --nthreads - i);
     ...
     *     argument is an instance of {@link java.lang.ThreadDeath}. If so, nothing
    ...
    public void uncaughtException(java.lang.Thread t, java.lang.Throwable e) {
        if (parent != null) {
            ...
            } else if (!(e instanceof java.lang.ThreadDeath)) {
                java.lang.System.err.print("Exception in thread \""
                                 + t.getName() + "\" ");
