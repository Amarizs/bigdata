...
final class ConditionalSpecialCasing {
    ...
    static Hashtable<java.lang.Integer, HashSet<Entry>> entryTable = new Hashtable<>();
    static {
        // create hashtable from the entry
        for (int i = 0; i < entry.length; i ++) {
            Entry cur = entry[i];
            java.lang.Integer cp = new java.lang.Integer(cur.getCodePoint());
    ...
    static int toLowerCaseEx(java.lang.String src, int index, Locale locale) {
    ...
    static int toUpperCaseEx(java.lang.String src, int index, Locale locale) {
    ...
    static char[] toLowerCaseCharArray(java.lang.String src, int index, Locale locale) {
        return lookUpTable(src, index, locale, true);
    }

    static char[] toUpperCaseCharArray(java.lang.String src, int index, Locale locale) {
        char[] result = lookUpTable(src, index, locale, false);
        if (result != null) {
            return result;
        } else {
    ...
    private static char[] lookUpTable(java.lang.String src, int index, Locale locale, boolean bLowerCasing) {
        HashSet<Entry> set = entryTable.get(new java.lang.Integer(src.codePointAt(index)));
        char[] ret = null;

        if (set != null) {
            Iterator<Entry> iter = set.iterator();
            java.lang.String currentLang = locale.getLanguage();
            while (iter.hasNext()) {
                Entry entry = iter.next();
                java.lang.String conditionLang = entry.getLanguage();
    ...
    private static boolean isConditionMet(java.lang.String src, int index, Locale locale, int condition) {
        switch (condition) {
        case FINAL_CASED:
     ...
     */
    private static boolean isFinalCased(java.lang.String src, int index, Locale locale) {
    ...
    static class Entry {
        ...
        Entry(int ch, char[] lower, char[] upper, java.lang.String lang, int condition) {
            this.ch = ch;
            this.lower = lower;
            this.upper = upper;
            this.lang = lang;
