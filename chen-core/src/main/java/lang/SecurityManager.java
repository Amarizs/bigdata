...
class SecurityManager {
    ...
    public void checkMulticast(InetAddress maddr) {
        java.lang.String host = maddr.getHostAddress();
        if (!host.startsWith("[") && host.indexOf(':') != -1) {
            host = "[" + host + "]";
        }
        checkPermission(new SocketPermission(host,
    ...
    private static java.lang.String[] getPackages(java.lang.String p) {
        java.lang.String packages[] = null;
        if (p != null && !p.equals("")) {
            java.util.StringTokenizer tok =
                new java.util.StringTokenizer(p, ",");
            int n = tok.countTokens();
            if (n > 0) {
                packages = new java.lang.String[n];
                int i = 0;
                while (tok.hasMoreElements()) {
                    java.lang.String s = tok.nextToken().trim();
                    packages[i++] = s;
                }
            }
        }
    ...
    public void checkPackageAccess(java.lang.String pkg) {
        ...
        synchronized (packageAccessLock) {
            ...
            if (!packageAccessValid) {
                java.lang.String tmpPropertyStr =
                    AccessController.doPrivileged(
                        new PrivilegedAction<java.lang.String>() {
