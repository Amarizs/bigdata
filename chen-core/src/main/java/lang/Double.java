...
public final class Double extends Number implements Comparable<Double> {
    ...
    public static final java.lang.Class<Double> TYPE = (java.lang.Class<Double>) java.lang.Class.getPrimitiveClass("double");
    ...
    public static String toHexString(double d) {
        ...
        if (!isFinite(d) )
            ...
            if(d == 0.0) {
                ...
                // trailing zeros.
                String signif = java.lang.Long.toHexString(signifBits).substring(3,16);
