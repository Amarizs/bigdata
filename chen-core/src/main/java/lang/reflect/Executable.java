...
public abstract class Executable extends AccessibleObject
    ...
    void printModifiersIfNonzero(StringBuilder sb, int mask, boolean isDefault) {
        ...
        if (mod != 0 && !isDefault) {
            ...
            int access_mod = mod & java.lang.reflect.Modifier.ACCESS_MODIFIERS;
            if (access_mod != 0)
                sb.append(java.lang.reflect.Modifier.toString(access_mod)).append(' ');
            if (isDefault)
                sb.append("default ");
            mod = (mod & ~java.lang.reflect.Modifier.ACCESS_MODIFIERS);
            if (mod != 0)
                sb.append(java.lang.reflect.Modifier.toString(mod)).append(' ');
        }
    }
    ...
    /**
     * Returns the Java language {@linkplain java.lang.reflect.Modifier modifiers} for
    ...
    java.lang.reflect.Type[] getAllGenericParameterTypes() {
        ...
        if (!genericInfo) {
            ...
            final java.lang.reflect.Type[] genericParamTypes = getGenericParameterTypes();
            final java.lang.reflect.Type[] nonGenericParamTypes = getParameterTypes();
            final java.lang.reflect.Type[] out = new java.lang.reflect.Type[nonGenericParamTypes.length];
            final java.lang.reflect.Parameter[] params = getParameters();
            int fromidx = 0;
    ...
    private java.lang.reflect.Parameter[] synthesizeAllParams() {
        ...
        final java.lang.reflect.Parameter[] out = new java.lang.reflect.Parameter[realparams];
        for (int i = 0; i < realparams; i++)
            // TODO: is there a way to synthetically derive the
            // modifiers?  Probably not in the general case, since
            // we'd have no way of knowing about them, but there
            // may be specific cases.
            out[i] = new java.lang.reflect.Parameter("arg" + i, 0, this, i);
        return out;
    }

    private void verifyParameters(final java.lang.reflect.Parameter[] parameters) {
        final int mask = java.lang.reflect.Modifier.FINAL | java.lang.reflect.Modifier.SYNTHETIC | java.lang.reflect.Modifier.MANDATED;
    ...
    private java.lang.reflect.Parameter[] privateGetParameters() {
        ...
        java.lang.reflect.Parameter[] tmp = parameters;
    ...
    public boolean isVarArgs()  {
        return (getModifiers() & java.lang.reflect.Modifier.VARARGS) != 0;
    }
