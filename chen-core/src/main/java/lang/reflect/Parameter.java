...
public final class Parameter implements AnnotatedElement {
    ...
    public String toString() {
        ...
        final java.lang.reflect.Type type = getParameterizedType();
    ...
    public java.lang.reflect.Type getParameterizedType() {
        java.lang.reflect.Type tmp = parameterTypeCache;
        if (null == tmp) {
    ...
    public boolean isImplicit() {
        return java.lang.reflect.Modifier.isMandated(getModifiers());
    }
