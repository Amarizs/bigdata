...
public class IndexedPropertyDescriptor extends java.beans.PropertyDescriptor {
    ...
    public IndexedPropertyDescriptor(String propertyName, Class<?> beanClass)
        ...
        this(propertyName, beanClass,
             java.beans.Introspector.GET_PREFIX + java.beans.NameGenerator.capitalize(propertyName),
             java.beans.Introspector.SET_PREFIX + java.beans.NameGenerator.capitalize(propertyName),
             java.beans.Introspector.GET_PREFIX + java.beans.NameGenerator.capitalize(propertyName),
             java.beans.Introspector.SET_PREFIX + java.beans.NameGenerator.capitalize(propertyName));
    }
    ...
    public IndexedPropertyDescriptor(String propertyName, Class<?> beanClass,
        ...
        if (indexedReadMethodName != null && getIndexedReadMethod() == null) {
            throw new java.beans.IntrospectionException("Method not found: " + indexedReadMethodName);
        }

        this.indexedWriteMethodName = indexedWriteMethodName;
        if (indexedWriteMethodName != null && getIndexedWriteMethod() == null) {
            throw new java.beans.IntrospectionException("Method not found: " + indexedWriteMethodName);
        }
     ...
     * @exception java.beans.IntrospectionException if an exception occurs during introspection
     *
     * @since 1.7
     */
    IndexedPropertyDescriptor(Class<?> bean, String base, Method read, Method write, Method readIndexed, Method writeIndexed) throws java.beans.IntrospectionException {
    ...
    public synchronized Method getIndexedReadMethod() {
        ...
        if (indexedReadMethod == null) {
            ...
            String nextMethodName = java.beans.Introspector.GET_PREFIX + getBaseName();
            if (indexedReadMethodName == null) {
                Class<?> type = getIndexedPropertyType0();
                if (type == boolean.class || type == null) {
                    indexedReadMethodName = java.beans.Introspector.IS_PREFIX + getBaseName();
                } else {
            ...
            indexedReadMethod = java.beans.Introspector.findMethod(cls, indexedReadMethodName, 1, args);
     ...
     * @throws java.beans.IntrospectionException if an exception occurs during
     * introspection.
     */
    ...
    private void setIndexedReadMethod0(Method readMethod) {
        ...
        setTransient(readMethod.getAnnotation(java.beans.Transient.class));
    }
    ...
    public synchronized Method getIndexedWriteMethod() {
        ...
        if (indexedWriteMethod == null) {
            ...
            if (indexedWriteMethodName == null) {
                indexedWriteMethodName = java.beans.Introspector.SET_PREFIX + getBaseName();
            }
    ...
    private Class<?> findIndexedPropertyType(Method indexedReadMethod,
        ...
        if (indexedReadMethod != null) {
            ...
            if (params.length != 1) {
                throw new java.beans.IntrospectionException("bad indexed read method arg count");
            }
            if (params[0] != Integer.TYPE) {
                throw new java.beans.IntrospectionException("non int index to indexed read method");
            }
            indexedPropertyType = getReturnType(getClass0(), indexedReadMethod);
            if (indexedPropertyType == Void.TYPE) {
                throw new java.beans.IntrospectionException("indexed read method returns void");
            }
        }
        if (indexedWriteMethod != null) {
            Class params[] = getParameterTypes(getClass0(), indexedWriteMethod);
            if (params.length != 2) {
                throw new java.beans.IntrospectionException("bad indexed write method arg count");
            }
            if (params[0] != Integer.TYPE) {
                throw new java.beans.IntrospectionException("non int index to indexed write method");
            }
            if (indexedPropertyType == null || params[1].isAssignableFrom(indexedPropertyType)) {
                ...
                throw new java.beans.IntrospectionException(
        ...
        if (propertyType != null && (!propertyType.isArray() ||
            ...
            throw new java.beans.IntrospectionException("type mismatch between indexed and non-indexed methods: "
                                             + getName());
        }
    ...
    IndexedPropertyDescriptor(java.beans.PropertyDescriptor x, PropertyDescriptor y) {
        super(x,y);
