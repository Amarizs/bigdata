...
public class EventHandler implements InvocationHandler {
    ...
    private Object applyGetters(Object target, String getters) {
        ...
        try {
            Method getter = null;
            if (target != null) {
                getter = java.beans.Statement.getMethod(target.getClass(),
                ...
                if (getter == null) {
                    getter = java.beans.Statement.getMethod(target.getClass(), first, new Class<?>[]{});
                }
            }
            if (getter == null) {
    ...
    private Object invokeInternal(Object proxy, Method method, Object[] arguments) {
        ...
        if (listenerMethodName == null || listenerMethodName.equals(methodName)) {
            ...
            try {
                ...
                Method targetMethod = java.beans.Statement.getMethod(
