...
public class XMLEncoder extends Encoder implements AutoCloseable {
    ...
    private Map<Object, List<java.beans.Statement>> targetToStatementList;
    ...
    private class ValueData {
        ...
        public java.beans.Expression exp = null;
    }
     ...
     *
     * @see java.beans.XMLDecoder#XMLDecoder(InputStream)
     */
    ...
    public void setOwner(Object owner) {
        this.owner = owner;
        writeExpression(new java.beans.Expression(this, "getOwner", new Object[0]));
    }
    ...
    public void writeObject(Object o) {
        if (internal) {
            ...
            writeStatement(new java.beans.Statement(this, "writeObject", new Object[]{o}));
        }
    }

    private List<java.beans.Statement> statementList(Object target) {
        List<java.beans.Statement> list = targetToStatementList.get(target);
        if (list == null) {
            list = new ArrayList<>();
    ...
    private void mark(Object o, boolean isArgument) {
        ...
        java.beans.Expression exp = d.exp;
    ...
    private void mark(java.beans.Statement stm) {
        ...
        mark(stm.getTarget(), stm instanceof java.beans.Expression);
    }
    ...
    public void flush() {
        ...
        indentation++;
        List<java.beans.Statement> statements = statementList(this);
        while (!statements.isEmpty()) {
            java.beans.Statement s = statements.remove(0);
        ...
        java.beans.Statement statement = getMissedStatement();
    ...
    java.beans.Statement getMissedStatement() {
        for (List<java.beans.Statement> statements : this.targetToStatementList.values()) {
            for (int i = 0; i < statements.size(); i++) {
                if (java.beans.Statement.class == statements.get(i).getClass()) {
    ...
    private void outputStatement(java.beans.Statement exp, Object outer, boolean isArgument) {
        Object target = exp.getTarget();
        ...
        boolean expression = exp.getClass() == java.beans.Expression.class;
        ...
        if (target == outer) {
            ...
            if (d.name == null) {
                ...
                List<java.beans.Statement> statements = statementList(target);
    ...
    private void outputXML(String tag, String attributes, Object value, Object... args) {
        List<java.beans.Statement> statements = statementList(value);
