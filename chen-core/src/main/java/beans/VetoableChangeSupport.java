...
public class VetoableChangeSupport implements Serializable {
     ...
     * {@link #fireVetoableChange(java.beans.PropertyChangeEvent)} method.
     *
    ...
    public void fireVetoableChange(String propertyName, Object oldValue, Object newValue)
        ...
        if (oldValue == null || newValue == null || !oldValue.equals(newValue)) {
            fireVetoableChange(new java.beans.PropertyChangeEvent(this.source, propertyName, oldValue, newValue));
        }
    }
     ...
     */
    private static final class VetoableChangeListenerMap extends java.beans.ChangeListenerMap<VetoableChangeListener> {
