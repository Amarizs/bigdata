...
final class ThreadGroupContext {
    ...
    private static final java.beans.WeakIdentityMap<ThreadGroupContext> contexts = new java.beans.WeakIdentityMap<ThreadGroupContext>() {
    ...
    private Map<Class<?>, java.beans.BeanInfo> beanInfoCache;
    ...
    java.beans.BeanInfo putBeanInfo(Class<?> type, BeanInfo info) {
