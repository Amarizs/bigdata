...
public class PropertyDescriptor extends FeatureDescriptor {
    ...
    private final java.beans.MethodRef readMethodRef = new java.beans.MethodRef();
    private final java.beans.MethodRef writeMethodRef = new java.beans.MethodRef();
    ...
    public PropertyDescriptor(String propertyName, Class<?> beanClass)
        ...
        this(propertyName, beanClass,
                java.beans.Introspector.IS_PREFIX + java.beans.NameGenerator.capitalize(propertyName),
    ...
    public PropertyDescriptor(String propertyName, Class<?> beanClass,
        ...
        this.bound = null != java.beans.Introspector.findMethod(beanClass, "addPropertyChangeListener", args.length, args);
    }
    ...
    PropertyDescriptor(Class<?> bean, String base, Method read, Method write) throws IntrospectionException {
        ...
        setClass0(bean);
        setName(java.beans.Introspector.decapitalize(base));
        setReadMethod(read);
        ...
        if (readMethod == null) {
            ...
            if (readMethodName == null) {
                ...
                if (type == boolean.class || type == null) {
                    readMethodName = java.beans.Introspector.IS_PREFIX + getBaseName();
                } else {
            ...
            readMethod = java.beans.Introspector.findMethod(cls, readMethodName, 0);
    ...
    public synchronized Method getWriteMethod() {
        ...
        if (writeMethod == null) {
            ...
            if (writeMethodName == null) {
                writeMethodName = java.beans.Introspector.SET_PREFIX + getBaseName();
            }

            Class<?>[] args = (type == null) ? null : new Class<?>[] { type };
            writeMethod = java.beans.Introspector.findMethod(cls, writeMethodName, 1, args);
            if (writeMethod != null) {
     ...
     * @since 1.5
     */
    public java.beans.PropertyEditor createPropertyEditor(Object bean) {
        Object editor = null;

        final Class<?> cls = getPropertyEditorClass();
        if (cls != null && java.beans.PropertyEditor.class.isAssignableFrom(cls)
    ...
    PropertyDescriptor(PropertyDescriptor x, PropertyDescriptor y) {
        ...
        if (xr != null && yr != null &&
                   ...
                   xr.getName().indexOf(java.beans.Introspector.IS_PREFIX) == 0 &&
    ...
    String getBaseName() {
        if (baseName == null) {
            baseName = java.beans.NameGenerator.capitalize(getName());
        }
        return baseName;
    }
