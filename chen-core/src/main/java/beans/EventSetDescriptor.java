...
public class EventSetDescriptor extends FeatureDescriptor {
    ...
    public EventSetDescriptor(Class<?> sourceClass, String eventSetName,
        ...
        this(sourceClass, eventSetName, listenerType,
             ...
             java.beans.Introspector.ADD_PREFIX + getListenerClassName(listenerType),
             java.beans.Introspector.REMOVE_PREFIX + getListenerClassName(listenerType),
             java.beans.Introspector.GET_PREFIX + getListenerClassName(listenerType) + "s");

        String eventName = java.beans.NameGenerator.capitalize(eventSetName) + "Event";
    ...
    public EventSetDescriptor(Class<?> sourceClass,
        ...
        Method method = java.beans.Introspector.findMethod(sourceClass, getListenerMethodName, 0);
        if (method != null) {
    ...
    private void setListenerMethods(Method[] methods) {
        ...
        if (listenerMethodDescriptors == null) {
            listenerMethodDescriptors = new java.beans.MethodDescriptor[methods.length];
            for (int i = 0; i < methods.length; i++) {
                listenerMethodDescriptors[i] = new java.beans.MethodDescriptor(methods[i]);
            }
        }
    ...
    private synchronized void setAddListenerMethod(Method method) {
        ...
        addMethodDescriptor = new java.beans.MethodDescriptor(method);
        setTransient(method.getAnnotation(java.beans.Transient.class));
    }
    ...
    private synchronized void setRemoveListenerMethod(Method method) {
        ...
        removeMethodDescriptor = new java.beans.MethodDescriptor(method);
        setTransient(method.getAnnotation(java.beans.Transient.class));
    }
    ...
    private synchronized void setGetListenerMethod(Method method) {
        ...
        getMethodDescriptor = new java.beans.MethodDescriptor(method);
    ...
    EventSetDescriptor(EventSetDescriptor old) {
        ...
        if (old.listenerMethodDescriptors != null) {
            ...
            listenerMethodDescriptors = new java.beans.MethodDescriptor[len];
            for (int i = 0; i < len; i++) {
                listenerMethodDescriptors[i] = new java.beans.MethodDescriptor(
