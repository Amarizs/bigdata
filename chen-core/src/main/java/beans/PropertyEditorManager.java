...
public class PropertyEditorManager {
    ...
    public static void registerEditor(Class<?> targetType, Class<?> editorClass) {
        ...
        java.beans.ThreadGroupContext.getContext().getPropertyEditorFinder().register(targetType, editorClass);
    }
    ...
    public static PropertyEditor findEditor(Class<?> targetType) {
        return java.beans.ThreadGroupContext.getContext().getPropertyEditorFinder().find(targetType);
    }
    ...
    public static String[] getEditorSearchPath() {
        return java.beans.ThreadGroupContext.getContext().getPropertyEditorFinder().getPackages();
    }
    ...
    public static void setEditorSearchPath(String[] path) {
        ...
        java.beans.ThreadGroupContext.getContext().getPropertyEditorFinder().setPackages(path);
    }
}
