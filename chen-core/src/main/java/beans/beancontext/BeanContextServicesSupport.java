...
public class      BeanContextServicesSupport extends java.beans.beancontext.BeanContextSupport
    ...
    public BeanContextServicesSupport(java.beans.beancontext.BeanContextServices peer, Locale lcle, boolean dTime, boolean visible) {
    ...
    public BeanContextServicesSupport(java.beans.beancontext.BeanContextServices peer, Locale lcle, boolean dtime) {
    ...
    public BeanContextServicesSupport(java.beans.beancontext.BeanContextServices peer, Locale lcle) {
    ...
    public java.beans.beancontext.BeanContextServices getBeanContextServicesPeer() {
        return (java.beans.beancontext.BeanContextServices)getBeanContextChildPeer();
    }
    ...
    protected class BCSSChild extends BCSChild  {
        ...
        class BCSSCServiceClassRef {
            ...
            BCSSCServiceClassRef(Class sc, java.beans.beancontext.BeanContextServiceProvider bcsp, boolean delegated) {
                super();
            ...
            void verifyAndMaybeSetProvider(java.beans.beancontext.BeanContextServiceProvider bcsp, boolean isDelegated) {
                java.beans.beancontext.BeanContextServiceProvider current;
            ...
            java.beans.beancontext.BeanContextServiceProvider delegateProvider; // proxy
            int                                 delegateRefs;
        ...
        synchronized void usingService(Object requestor, Object service, Class serviceClass, java.beans.beancontext.BeanContextServiceProvider bcsp, boolean isDelegated, BeanContextServiceRevokedListener bcsrl)  throws TooManyListenersException, UnsupportedOperationException {
        ...
        synchronized void releaseService(Object requestor, Object service) {
            ...
            java.beans.beancontext.BeanContextServiceProvider bcsp        = isDelegated ? serviceClassRef.getDelegateProvider() : serviceClassRef.getServiceProvider();
        ...
        void cleanupReferences() {
            ...
            while(requestors.hasNext()) {
                ...
                while (services.hasNext()) {
                    ...
                    java.beans.beancontext.BeanContextServiceProvider bcsp  = sref.isDelegated() ? scref.getDelegateProvider() : scref.getServiceProvider();
    ...
    /************************************************************************/
        ...
        protected static class BCSSServiceProvider implements Serializable {
            ...
            BCSSServiceProvider(Class sc, java.beans.beancontext.BeanContextServiceProvider bcsp) {
                super();
             ...
             */
            protected java.beans.beancontext.BeanContextServiceProvider getServiceProvider() {
                return serviceProvider;
            }
        ...
        protected BCSSServiceProvider createBCSSServiceProvider(Class sc, java.beans.beancontext.BeanContextServiceProvider bcsp) {
    ...
    public boolean addService(Class serviceClass, java.beans.beancontext.BeanContextServiceProvider bcsp) {
    ...
    protected boolean addService(Class serviceClass, java.beans.beancontext.BeanContextServiceProvider bcsp, boolean fireEvent) {

        if (serviceClass == null) throw new NullPointerException("serviceClass");
        if (bcsp         == null) throw new NullPointerException("bcsp");

        synchronized(java.beans.beancontext.BeanContext.globalHierarchyLock) {
            if (services.containsKey(serviceClass))
                ...
                synchronized(children) {
                    ...
                    while (i.hasNext()) {
                        ...
                        if (c instanceof java.beans.beancontext.BeanContextServices) {
    ...
    public void revokeService(Class serviceClass, java.beans.beancontext.BeanContextServiceProvider bcsp, boolean revokeCurrentServicesNow) {
    ...
    public synchronized boolean hasService(Class serviceClass) {
        ...
        synchronized(java.beans.beancontext.BeanContext.globalHierarchyLock) {
            ...
            java.beans.beancontext.BeanContextServices bcs = null;

            try {
                bcs = (java.beans.beancontext.BeanContextServices)getBeanContext();
    ...
    protected class BCSSProxyServiceProvider implements java.beans.beancontext.BeanContextServiceProvider, BeanContextServiceRevokedListener {

        BCSSProxyServiceProvider(java.beans.beancontext.BeanContextServices bcs) {
            super();

            nestingCtxt = bcs;
        }

        public Object getService(java.beans.beancontext.BeanContextServices bcs, Object requestor, Class serviceClass, Object serviceSelector) {
            Object service = null;
        ...
        public void releaseService(java.beans.beancontext.BeanContextServices bcs, Object requestor, Object service) {
            nestingCtxt.releaseService(bcs, requestor, service);
        }

        public Iterator getCurrentServiceSelectors(java.beans.beancontext.BeanContextServices bcs, Class serviceClass) {
     ...
     */
     ...
     public Object getService(java.beans.beancontext.BeanContextChild child, Object requestor, Class serviceClass, Object serviceSelector, BeanContextServiceRevokedListener bcsrl) throws TooManyListenersException {
        ...
        Object              service = null;
        BCSSChild           bcsc;
        java.beans.beancontext.BeanContextServices bcssp   = getBeanContextServicesPeer();
    ...
    protected synchronized void initializeBeanContextResources() {
        ...
        try {
            java.beans.beancontext.BeanContextServices bcs = (BeanContextServices)nbc;
