...
public class BeanContextChildSupport implements java.beans.beancontext.BeanContextChild, BeanContextServicesListener, Serializable {
     ...
     */
    public synchronized void setBeanContext(java.beans.beancontext.BeanContext bc) throws PropertyVetoException {
        if (bc == beanContext) return;

        java.beans.beancontext.BeanContext oldValue = beanContext;
        java.beans.beancontext.BeanContext newValue = bc;
     ...
     * this <code>BeanContextChildSupport</code>.
     */
    public synchronized java.beans.beancontext.BeanContext getBeanContext() { return beanContext; }
     ...
     */
    public java.beans.beancontext.BeanContextChild getBeanContextChildPeer() { return beanContextChildPeer; }
