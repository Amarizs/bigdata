...
public class Introspector {
    ...
    private java.beans.BeanInfo explicitBeanInfo;
    private java.beans.BeanInfo superBeanInfo;
    private java.beans.BeanInfo additionalBeanInfo[];
     ...
     * @see #flushFromCaches
     */
    public static java.beans.BeanInfo getBeanInfo(Class<?> beanClass)
     ...
     *              introspection.
     */
    public static java.beans.BeanInfo getBeanInfo(Class<?> beanClass, int flags)
                                                throws IntrospectionException {
     ...
     *              introspection.
     */
    public static java.beans.BeanInfo getBeanInfo(Class<?> beanClass, Class<?> stopClass)
                                                throws IntrospectionException {
    ...
    private Introspector(Class<?> beanClass, Class<?> stopClass, int flags)
        ...
        if (additionalBeanInfo == null) {
            additionalBeanInfo = new java.beans.BeanInfo[0];
        }
    }
     ...
     */
    private java.beans.BeanInfo getBeanInfo() throws IntrospectionException {
     ...
     */
    private static java.beans.BeanInfo findExplicitBeanInfo(Class<?> beanClass) {
    ...
    private PropertyDescriptor[] getPropertyDescriptors(java.beans.BeanInfo info) {
...
class GenericBeanInfo extends SimpleBeanInfo {
    ...
    private Reference<java.beans.BeanInfo> targetBeanInfoRef;

    public GenericBeanInfo(BeanDescriptor beanDescriptor,
                EventSetDescriptor[] events, int defaultEvent,
                PropertyDescriptor[] properties, int defaultProperty,
                MethodDescriptor[] methods, java.beans.BeanInfo targetBeanInfo) {
    ...
    public java.awt.Image getIcon(int iconKind) {
        java.beans.BeanInfo targetBeanInfo = getTargetBeanInfo();
