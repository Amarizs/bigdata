...
public class PropertyChangeSupport implements Serializable {
    ...
    public void firePropertyChange(String propertyName, Object oldValue, Object newValue) {
        if (oldValue == null || newValue == null || !oldValue.equals(newValue)) {
            firePropertyChange(new java.beans.PropertyChangeEvent(this.source, propertyName, oldValue, newValue));
        }
    }
    ...
    private static void fire(PropertyChangeListener[] listeners, java.beans.PropertyChangeEvent event) {
        if (listeners != null) {
    ...
    /**
     * This is a {@link java.beans.ChangeListenerMap ChangeListenerMap} implementation
     * that works with {@link PropertyChangeListener PropertyChangeListener} objects.
     */
    private static final class PropertyChangeListenerMap extends java.beans.ChangeListenerMap<PropertyChangeListener> {
